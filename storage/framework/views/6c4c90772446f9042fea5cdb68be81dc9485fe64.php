<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('project/Selfassessment/title.nhanxetbc'); ?>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="container-fuild">
                    <h4 class="h4-left"><?php echo app('translator')->get('project/Selfassessment/title.baocaocnx'); ?></h4><br/>
...
<script>
    ...
    function selectBC(dat){
        ...
        $.ajax({
            url: "<?php echo route('admin.tudanhgia.commentreport.data'); ?>?id=" + dat.id,
            type: 'GET',
            error: function(err) {
            ...
            success: function(data) {
                ...
                if(data.tieuchuan_tieuchi == 0){
                    ...
                    texto += data.phan2 ;
                    var check = false;
                    var  ccb = '' + "<?php echo app('translator')->get('project/Selfassessment/title.chuacongbo'); ?>";
                        ...
                        if(value.baoCaoTieuChuan != undefined){
                            ...
                            if(value.baoCaoTieuChuan.trang_thai_bctc){
                                if(value.baoCaoTieuChuan.trang_thai_bctc == 'congbo'){
                                    name_trangthai = '<i class="fas fa-eye"></i>' + "<?php echo app('translator')->get('project/Selfassessment/title.xemvnx'); ?>";
                                    ...
                                    name_trangthai = '' + "<?php echo app('translator')->get('project/Selfassessment/title.chuacongbo'); ?>";
                                    css_color = 'css_color_organe';
                                }
                            }
                            ...
                            if(value.stt_tc){
                                ...
                                if(value.baoCaoTieuChuan.trang_thai_bctc == 'congbo'){
                                    texto += value.stt_tc + ": &nbsp; </span>" + '<a href="" style="width: 46%;">' + value.mo_ta + '</a>' + `<a href="<?php echo e(route('admin.tudanhgia.commentreport.viewReport')); ?>?id=${value.id_kh_baocao}&tieuchuan_id=${value.tieuchuan_id}" class="${css_trangthai } ${css_color}">` +name_trangthai+ '</a>'+'</br>'+'</p>';
                                }else{
    ...
    $(function () {
        table = $('#table').DataTable({
            ...
            serverSide: true,
            searching:false,
            ajax: "<?php echo route('admin.tudanhgia.commentreport.data'); ?>",
            order: [],
            columns: [
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\file_moi\xampp\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Selfassessment/comreport.blade.php ENDPATH**/ ?>