    ...
    <div class="container-fuild mt-3">
        ...
        <form action="<?php echo e(route('admin.thuongtruc.manacategory.createUnit')); ?>" method="post">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-1">
                    <button href="" class="btn btn-benchmark mr-2" type="button" data-toggle="modal" data-target="#modal_unit" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Standard/title.nhap_excel'); ?>">
                        <i class="bi bi-file-earmark-arrow-up" style="font-size: 35px;color: #50cd89;"></i>
                    </button>
                </div>
                <div class="col-md-1">
                    <a href="<?php echo e(route('admin.thuongtruc.manacategory.exportUnit')); ?>" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Standard/title.xuat_excel'); ?>">
                            ...
                            <div class="form-group col-md-12">
                                <div class="card my-3">
                                    <div class="card-header bg-primary text-white ">
                                        <div class="bootstrap-admin-box-title editor-clr">
                                            <i class="livicon" data-name="thermo-down" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                            <?php echo app('translator')->get('project/Standard/title.gioithieu'); ?>
                                        </div>
                                    </div>
                                    <div class="bootstrap-admin-card-content">
                            ...
                            <div class="form-group col-md-12">
                                <div class="card my-3">
                                    <div class="card-header bg-warning text-white ">
                                        <div class="bootstrap-admin-box-title editor-clr">
                                            <i class="livicon" data-name="thermo-down" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                            <?php echo app('translator')->get('project/Standard/title.cctc'); ?>
                                        </div>
                                    </div>
                                    <div class="bootstrap-admin-card-content">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Standard/mana_manaunit.blade.php ENDPATH**/ ?>