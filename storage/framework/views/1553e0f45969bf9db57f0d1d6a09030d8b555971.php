...
<html lang="en">
    ...
    <head><base href="">
        <title>
            <?php $__env->startSection('title'); ?>
                | <?php echo app('translator')->get('default.kdcl'); ?>
            <?php echo $__env->yieldSection(); ?>
        </title>

        <meta class="csrf-token" name="csrf-token" content="<?php echo e(csrf_token()); ?>">
        ...
        <link rel="shortcut icon" href="https://upload.wikimedia.org/wikipedia/commons/3/3f/Uneti-2.png" />
        <!--begin::Fonts-->
        ...
        <!-- Hệ thống cũ -->
        <link rel="stylesheet" href="<?php echo e(asset('css/select2-4.1.0-rc.0/dist/css/select2.min.css')); ?>">
        <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('vendors/bootstrap-datetime-picker/css/bootstrap-datetimepicker.min.css')); ?>">
        ...
        <style>
            @font-face {
              ...
              src: url('<?php echo e(asset("font/Open_Sans/static/OpenSans/OpenSans-Medium.ttf")); ?>');
            }
            ...
            .aside-menu .menu-item .menu-link.active{
                background-color: #3ad424 !important;
            }
            ...
            tbody tr td:last-child  button.mt-2{
                margin: 0 !important;
            }
            span ,strong, a, p,b,th,td,small,label{
    ...
    <body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
                ...
                <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                    ...
                    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                        ...
                        <a href="<?php echo e(route('admin.dashboard')); ?>">
                            <img alt="Logo" src="https://upload.wikimedia.org/wikipedia/commons/3/3f/Uneti-2.png" class="logo" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Aside toggler-->
                    ...
                    <!--end::Brand-->
                    <!--begin::Aside menu-->
                    <?php if(Request::is('admin/danh-gia-ngoai/bao-cao-tdg/bao-cao/*')): ?>
                        <?php echo $__env->make('admin.layouts._left_menu_baocao', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php else: ?>
                                    ...
                                    <div class="topbar d-flex align-items-stretch flex-shrink-0">
                                        ...
                                        <div class="d-flex align-items-stretch">
                                            ...
                                            <div class="noti-child menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px">
                                                <!--begin::Heading-->
                                                <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo e(asset("assets/media/misc/pattern-1.jpg")); ?>')">
                                                    <!--begin::Title-->
                                        ...
                                        <div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
                                            <!--begin::Menu wrapper-->
                                            <div class="drop-icon topbar-item cursor-pointer symbol px-3 px-lg-5 me-n3 me-lg-n5 symbol-30px symbol-md-35px">
                                            ...
                                            <div class="sub-drop-icon menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px">
                                                ...
                                                <div class="menu-item px-3">
                                                    <div class="menu-content d-flex align-items-center px-3">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="fw-bolder d-flex align-items-center fs-5"><?php echo e(Sentinel::getUser()->name); ?>
                                                ...
                                                <div class="menu-item px-5">
                                                    <a href="<?php echo e(URL::route('admin.users.show',Sentinel::getUser()->id)); ?>" class="menu-link px-5"><?php echo app('translator')->get('default.tttk'); ?></a>
                                                </div>
                                                <!--end::Menu item-->

                                                <!--begin::Menu item-->
                                                <!-- <div class="menu-item px-5">
                                                    <a href="<?php echo e(route('admin.users.edit', Sentinel::getUser()->id)); ?>" class="menu-link px-5">
                                                        <span class="menu-text"><?php echo app('translator')->get('default.stk'); ?></span>
                                                    </a>
                                                </div> -->
                                                <!--end::Menu item-->
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-5">
                                                    <a href="<?php echo e(URL::to('admin/logout')); ?>" class="menu-link px-5"><?php echo app('translator')->get('default.logout'); ?></a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
                    ...
                    <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="" target="_blank" class="text-gray-800 text-hover-primary"><?php echo app('translator')->get('default.kdcl'); ?></a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
                                    ...
                                    <div class="pe-3 mb-5">
                                        ...
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
                                                <img src="<?php echo e(asset('assets/media/avatars/150-11.jpg')); ?>" alt="img" />
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Description-->
                                    ...
                                    <div class="overflow-auto pb-5">
                                        ...
                                        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                            ...
                                            <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                                ...
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="<?php echo e(asset('assets/media/avatars/150-3.jpg')); ?>" alt="img" />
                                                </div>
                                                <!--end::User-->
                                                <!--begin::User-->
                                                <div class="symbol symbol-circle symbol-25px">
                                        ...
                                        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                            ...
                                            <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                                <!--begin::User-->
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="<?php echo e(asset('assets/media/avatars/150-5.jpg')); ?>" alt="img" />
                                                </div>
                                                <!--end::User-->
                                                <!--begin::User-->
                                                <div class="symbol symbol-circle symbol-25px">
                                    ...
                                    <div class="overflow-auto pe-3">
                                        ...
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
                                                <img src="<?php echo e(asset('assets/media/avatars/150-2.jpg')); ?>" alt="img" />
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Description-->
                                    ...
                                    <div class="mb-5 pe-3">
                                        ...
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
                                                <img src="<?php echo e(asset('assets/media/avatars/150-6.jpg')); ?>" alt="img" />
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Description-->
                                    ...
                                    <div class="overflow-auto pb-5">
                                        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                            ...
                                            <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                <!--begin::Icon-->
                                                <img alt="" class="w-30px me-3" src="<?php echo e(asset('assets/media/svg/files/pdf.svg')); ?>" />
                                                <!--end::Icon-->
                                                <!--begin::Info-->
                                            ...
                                            <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                <!--begin::Icon-->
                                                <img alt="" class="w-30px me-3" src="<?php echo e(asset('assets/media/svg/files/doc.svg')); ?>" />
                                                <!--end::Icon-->
                                                <!--begin::Info-->
                                                <div class="ms-1 fw-bold">
                                                    <!--begin::Desc-->
                                            ...
                                            <div class="d-flex flex-aligns-center">
                                                <!--begin::Icon-->
                                                <img alt="" class="w-30px me-3" src="<?php echo e(asset('assets/media/svg/files/css.svg')); ?>" />
                                                <!--end::Icon-->
                                                <!--begin::Info-->
                                                <div class="ms-1 fw-bold">
                                                    <!--begin::Desc-->
                                    ...
                                    <div class="pe-3 mb-5">
                                        ...
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
                                                <img src="<?php echo e(asset('assets/media/avatars/150-14.jpg')); ?>" alt="img" />
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Description-->
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-15.jpg')); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-3">
                        ...
                        <div class="d-flex justify-content-end mb-10">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-26.jpg')); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                </div>
                                <!--end::User-->
                            ...
                            <div class="mb-0">
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo1.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo2.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo3.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo4.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo5.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo6.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo7.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo8.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo9.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo10.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo11.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo12.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo13.png')); ?>" alt="demo" class="w-100" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo14.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo15.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo16.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo17.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo18.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo19.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                            <div class="overlay-wrapper">
                                                <img src="<?php echo e(asset('assets/media/demos/demo20.png')); ?>" alt="demo" class="w-100 opacity-25" />
                                            </div>
                                            <div class="overlay-layer bg-dark bg-opacity-10">
                                                <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                            </div>
            ...
            <div class="modal-dialog mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                        ...
                        <img alt="Logo" src="<?php echo e(asset('assets/media/svg/brand-logos/google-icon.svg')); ?>" class="h-20px me-3" />Invite Gmail Contacts</div>
                            ...
                            <div class="mh-300px scroll-y me-n7 pe-7">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-1.jpg')); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-4.jpg')); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-8.jpg')); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-6.jpg')); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-7.jpg')); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-17.jpg')); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/150-10.jpg')); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                            ...
                                            <div class="d-flex flex-column mb-7 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                        <img src="<?php echo e(asset('assets/media/svg/card-logos/visa.svg')); ?>" alt="" class="h-25px" />
                                                        <img src="<?php echo e(asset('assets/media/svg/card-logos/mastercard.svg')); ?>" alt="" class="h-25px" />
                                                        <img src="<?php echo e(asset('assets/media/svg/card-logos/american-express.svg')); ?>" alt="" class="h-25px" />
                                                    </div>
                                                    <!--end::Card logos-->
                                                </div>
                                                <!--end::Input wrapper-->
                                    ...
                                    <div data-kt-stepper-element="content">
                                        <div class="w-100 text-center">
                                            ...
                                            <div class="text-center px-4 py-15">
                                                <img src="<?php echo e(asset('assets/media/illustrations/unitedpalms-1/9.png')); ?>" alt="" class="w-100 mh-300px" />
                                            </div>
                                            <!--end::Illustration-->
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <?php echo app('translator')->get('project/ImportdataExcel/title.canhbao'); ?>
                    </h5>
                ...
                <div class="modal-body">
                    <?php echo app('translator')->get('project/ImportdataExcel/title.deleteAll'); ?> <br>
                    <span class="text-danger"><?php echo app('translator')->get('project/ImportdataExcel/title.hdkht'); ?></span>
                </div>
                <div class="modal-footer">
                    <a href="#" id="deleteAllTable__" class="btn btn-danger">
                        <?php echo app('translator')->get('project/ImportdataExcel/title.deleteAll'); ?>
                    </a>
                </div>
                </div>
            </div>
        ...
        <!-- hệ thống cũ -->
        <script type="text/javascript" src="<?php echo e(asset('css/select2-4.1.0-rc.0/dist/js/select2.min.js')); ?>"></script>
        ...
        <script>
            $('#modalDeleteAll__').on('show.bs.modal', function (event) {
                ...
                var modal = $(this)
                modal.find('#deleteAllTable__').attr('href', "<?php echo e(route('admin.importdata.tuyensinh.deleteDataTable')); ?>?nametable=" + recipient)
            })
        </script>
...
<?php /**PATH D:\file_moi\xampp\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/layouts/default.blade.php ENDPATH**/ ?>