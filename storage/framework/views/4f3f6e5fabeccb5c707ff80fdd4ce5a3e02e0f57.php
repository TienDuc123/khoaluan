                    ...
                    <div class="menu-item">
                        <a class="menu-link
                                    ...
                                    Request::is('admin/dam-bao-chat-luong/manaproof/edit-proof/*')
                                     ...
                                     "
                            href="<?php echo e(route('admin.dambaochatluong.manaproof.listdonvi')); ?>" data-bs-toggle="tooltip" data-bs-trigger="hover"
                            data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
                                <?php echo $icon_array[array_rand($icon_array, 1)]; ?>

                            </span>
                            <span class="menu-title">Cơ sở dữ liệu</span>
                        </a>
                    </div>
                    <!-- QL bộ tiêu chuẩn -->
                    <div class="menu-item">
...
<?php /**PATH D:\xamppkhoaluan\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/layouts/_left_menu.blade.php ENDPATH**/ ?>