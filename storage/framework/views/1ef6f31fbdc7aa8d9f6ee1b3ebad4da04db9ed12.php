      	...
      	<div class="m-t-md">
		    ...
		    <form action="<?php echo e(route('admin.tudanhgia.database.save_file_ctdt')); ?>" method="POST" enctype="multipart/form-data">
			    ...
			    <div>
					...
					<div class="import_ex">
						<?php if(isset($data['p26'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p26']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			  	...
			  	<div>
			  		...
			  		<input type="number" class="edit_input" value="<?php echo e($dulieu->p27_caodang); ?>" data_key="p27_caodang" min="0">
			  	</div>
			  	<div>
			  		<span>Số lượng chuyên ngành đào tạo Đại học :</span>
			  		<input type="number" class="edit_input" value="<?php echo e($dulieu->p27_daihoc); ?>" data_key="p27_daihoc" min="0">
			  	</div>
			  	<div>
			  		<span>Số lượng chuyên ngành đào tạo Thạc sĩ :</span>
			  		<input type="number" class="edit_input" value="<?php echo e($dulieu->p27_thacsi); ?>" data_key="p27_thacsi" min="0">
			  	</div>
			  	<div>
			  		<span>Số lượng chuyên ngành đào tạo Tiến sĩ :</span>
			  		<input type="number" class="edit_input" value="<?php echo e($dulieu->p27_tiensi); ?>" data_key="p27_tiensi" min="0">
			  	</div>
			    ...
			    <p><i><strong><?php echo app('translator')->get('project/Externalreview/title.28'); ?></strong></i></p>
			    ...
			    <p><i><strong><?php echo app('translator')->get('project/Externalreview/title.29'); ?><b>
			    	<input type="number" class="edit_input" value="<?php echo e($dulieu->p29_tongnganhdt); ?>" data_key="p29_tongnganhdt" min="0">
			    </b></strong></i></p>
		    	...
		    	<div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p30'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p30']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
			    ...
			    <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p31_1'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p31_1']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
			    ...
			    <p>Tổng số giảng viên cơ hữu :
			    	<input type="number" class="edit_input" value="<?php echo e($dulieu->p31_tongvcohuu); ?>" data_key="p31_tongvcohuu" min="0">
			    </p>
			    <p><?php echo app('translator')->get('project/Externalreview/title.tile'); ?>
			       <input type="number" class="edit_input" value="<?php echo e($dulieu->p31_tylegvch); ?>" data_key="p31_tylegvch" min="0">
			     </p>
			    ...
			    <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p31'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p31']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p32'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p32']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>

		        <p><?php echo app('translator')->get('project/Externalreview/title.33cham1'); ?>
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p33_1_tuoitb); ?>" data_key="p33_1_tuoitb" min="0">
		        </p>
		        <p><?php echo app('translator')->get('project/Externalreview/title.33cham2'); ?>
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p33_2_tdts); ?>" data_key="p33_2_tdts" min="0">
		        </p>
		        <p><?php echo app('translator')->get('project/Externalreview/title.33cham3'); ?>
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p33_3_tdths); ?>" data_key="p33_3_tdths" min="0">
		        </p>
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p33'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p33']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
			    ...
			    <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p34'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p34']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
	    		...
	    		<div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p35'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p35']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
	    		...
	    		<div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p36'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p36']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p37'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p37']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
	    		...
	    		<div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p38'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p38']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
	    		...
	    		<div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p39'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p39']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
			    </div>
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p40'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p40']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p41'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p41']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
		        ...
		        <div>
		        	...
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p42_tsdetaiqd); ?>" data_key="p42_tsdetaiqd" min="0">
		        </div>
		        <div>
		        	<span>
		        	      Tỷ số đề tài nghiên cứu khoa học và chuyển giao khoa học công nghệ (quy đổi) trên cán bộ cơ hữu của đơn vị thực hiện CTĐT:
		            </span>
		            <input type="number" class="edit_input" value="<?php echo e($dulieu->p42_tysodtqd); ?>" data_key="p42_tysodtqd" min="0">
		        </div>
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p42'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p42']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p43'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p43']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p44'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p44']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
		        ...
		        <div>
		        	...
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p45_tsosach); ?>" data_key="p45_tsosach" min="0">
		        </div>
		        <div>
		        	<span>Tỷ số sách đã được xuất bản (quy đổi) trên cán bộ cơ hữu:</span>
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p45_tysosach); ?>" data_key="p45_tysosach" min="0">
		        </div>
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p45'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p45']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
		        ...
		        <div>
					...
					<span class="file_name text-warning fst-italic"></span>
					<div class="import_ex">
						<?php if(isset($data['p46'])): ?>
							<iframe src='<?php echo e(URL::to('/') . '/' . $data['p46']); ?>' frameborder='0'></iframe>
						<?php endif; ?>
					</div> 
		        ...
		        <div>
		        	...
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p47_tsobaitapchi); ?>" data_key="p47_tsobaitapchi" min="0">
		        </div>
		        <div>
		        	<span>Tỷ số bài đăng tạp chí (quy đổi) trên cán bộ cơ hữu : </span>
		        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p47_tysobaitapchi); ?>" data_key="p47_tysobaitapchi" min="0">
		        </div>
	      	</div>
	        ...
	        <div>
				...
				<span class="file_name text-warning fst-italic"></span>
				<div class="import_ex">
					<?php if(isset($data['p47'])): ?>
						<iframe src='<?php echo e(URL::to('/') . '/' . $data['p47']); ?>' frameborder='0'></iframe>
					<?php endif; ?>
				</div> 
	        ...
	        <div>
				...
				<span class="file_name text-warning fst-italic"></span>
				<div class="import_ex">
					<?php if(isset($data['p48'])): ?>
						<iframe src='<?php echo e(URL::to('/') . '/' . $data['p48']); ?>' frameborder='0'></iframe>
					<?php endif; ?>
				</div> 
		    ...
		    <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p49_tsobaibc); ?>" data_key="p49_tsobaibc" min="0">
	        </div>
	        <div>
	        	<span>Tỷ số bài báo cáo (quy đổi) trên cán bộ cơ hữu : </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p49_tysobaibc); ?>" data_key="p49_tysobaibc" min="0">
	        </div>
	        ...
	        <div>
				...
				<span class="file_name text-warning fst-italic"></span>
				<div class="import_ex">
					<?php if(isset($data['p49'])): ?>
						<iframe src='<?php echo e(URL::to('/') . '/' . $data['p49']); ?>' frameborder='0'></iframe>
					<?php endif; ?>
				</div> 
	        ...
	        <div>
				...
				<span class="file_name text-warning fst-italic"></span>
				<div class="import_ex">
					<?php if(isset($data['p50'])): ?>
						<iframe src='<?php echo e(URL::to('/') . '/' . $data['p50']); ?>' frameborder='0'></iframe>
					<?php endif; ?>
				</div> 
	        ...
	        <div>
				...
				<span class="file_name text-warning fst-italic"></span>
				<div class="import_ex">
					<?php if(isset($data['p51'])): ?>
						<iframe src='<?php echo e(URL::to('/') . '/' . $data['p51']); ?>' frameborder='0'></iframe>
					<?php endif; ?>
				</div> 
	        ...
	        <div>
				...
				<span class="file_name text-warning fst-italic"></span>
				<div class="import_ex">
					<?php if(isset($data['p52'])): ?>
						<iframe src='<?php echo e(URL::to('/') . '/' . $data['p52']); ?>' frameborder='0'></iframe>
					<?php endif; ?>
				</div> 
	        ...
	        <p><i><strong>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p53_tongdtdcsgd); ?>" data_key="p53_tongdtdcsgd" min="0">
	        </strong></i></p>
	        <p><i><strong>
	        	54. Tổng diện tích đất sử dụng của đơn vị thực hiện CTĐT (tính bằng m2):
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p53_tongdtdvth); ?>" data_key="p53_tongdtdvth" min="0">
	        </strong></i></p>
	        <p><i>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p55_noilmv); ?>" data_key="p55_noilmv" min="0">
	        </div>
	        <div>
	        	<span>- Nơi học:</span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p55_noihoc); ?>" data_key="p55_noihoc" min="0">
	        </div>
	        <div>
	        	<span>- Nơi vui chơi giải trí:</span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p55_noigt); ?>" data_key="p55_noigt" min="0">
	        </div>
	        <p><i><strong>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p56_tdtphong); ?>" data_key="p56_tdtphong" min="0">
	        </div>
	         <div>
	        	<span>- Tỷ số diện tích phòng học trên người học chính quy:</span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p56_tysodtpcq); ?>" data_key="p56_tysodtpcq" min="0">
	        </div>
	        <p><i><strong>
	        	57. Tổng số đầu sách thuộc ngành đào tạo được sử dụng tại Trung tâm Thông tin – Thư viện :
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p57_tsodstndt); ?>" data_key="p57_tsodstndt" min="0">
	        </strong></i></p>
	        <div>
	        	<span>- Tổng số đầu sách trong phòng tư liệu của đơn vị thực hiện CTĐT (nếu có):</span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p57_tsodstptl); ?>" data_key="p57_tsodstptl" min="0">
	        </div>
	        <p><i><strong>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p58_dchtvp); ?>" data_key="p58_dchtvp" min="0">
	        </div>
	        <div>
	        	<span>- Dùng cho người học học tập : </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p58_dcnht); ?>" data_key="p58_dcnht" min="0">
	        </div>
	        <div>
	        	<span>Tỷ số số máy tính dùng cho người học/người học chính quy: </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->p58_tsomtdcnh); ?>" data_key="p58_tsomtdcnh" min="0">
	        </div>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_1_tsgvch); ?>" data_key="viii_1_tsgvch" min="0">
	        </div>
	        <div>
	        	<span>Tỷ lệ giảng viên cơ hữu trên tổng số cán bộ cơ hữu (%): </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_1_tlgvch); ?>" data_key="viii_1_tlgvch" min="0">
	        </div>
	        <div>
	        	<span>Tỷ lệ giảng viên cơ hữu có trình độ tiến sĩ trở lên trên tổng số giảng viên cơ hữu của đơn vị thực hiện CTĐT (%): </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_1_gvchts); ?>" data_key="viii_1_gvchts" min="0">
	        </div>
	        <div>
	        	<span>Tỷ lệ giảng viên cơ hữu có trình độ thạc sĩ trên tổng số giảng viên cơ hữu của đơn vị thực hiện CTĐT (%): </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_1_gvchths); ?>" data_key="viii_1_gvchths" min="0">
	        </div>
	        <p><i>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_2_tsnhcq); ?>" data_key="viii_2_tsnhcq" min="0">
	        </div>
	        <div>
	        	<span>Tỷ số người học chính quy trên giảng viên theo CTĐT: </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_2_tsngcqtgv); ?>" data_key="viii_2_tsngcqtgv" min="0">
	        </div>
	        <div>
	        	<span>Tỷ lệ người học tốt nghiệp so với số tuyển vào (%): </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_2_tlnhtn); ?>" data_key="viii_2_tlnhtn" min="0">
	        </div>
	        <p><i>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_3_tlngtldh); ?>" data_key="viii_3_tlngtldh" min="0">
	        </div>
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_3_tlhmpkt); ?>" data_key="viii_3_tlhmpkt" min="0">
	        </div>
	        <p><i>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_5_tlhdunc); ?>" data_key="viii_5_tlhdunc" min="0">
	        </div>
	        <div>
	        	<span>Tỷ lệ người học cơ bản đáp ứng yêu cầu của công việc, nhưng phải đào tạo thêm (%): </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_5_nhcbdu); ?>" data_key="viii_5_nhcbdu" min="0">
	        </div>
	        <p><i><strong>
	        ...
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_6_tldtnckh); ?>" data_key="viii_6_tldtnckh" min="0">
	        </div>
	        <div>
	        ...
	        <div>
	        	<span>Tỷ số sách đã được xuất bản (quy đổi) trên cán bộ cơ hữu: </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_6_tssddsb); ?>" data_key="viii_6_tssddsb" min="0">
	        </div>
	        <div>
	        	<span>Tỷ số bài đăng tạp chí (quy đổi) trên cán bộ cơ hữu: </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_6_tsbdtc); ?>" data_key="viii_6_tsbdtc" min="0">
	        </div>
	        <div>
	        	<span>Tỷ số bài báo cáo (quy đổi) trên cán bộ cơ hữu: </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_6_tsbdbc); ?>" data_key="viii_6_tsbdbc" min="0">
	        </div>
	        <p><i><strong>
	        	7. Cơ sở vật chất:
	        </strong></i></p>
	        <div>
	        	...
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_7_tsmtdcnh); ?>" data_key="viii_7_tsmtdcnh" min="0">
	        </div>
	        <div>
	        	<span>Tỷ số diện tích phòng học trên người học chính quy: </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_7_tsdtp); ?>" data_key="viii_7_tsdtp" min="0">
	        </div>
	        <div>
	        	<span>Tỷ số diện tích ký túc xá trên người học chính quy: </span>
	        	<input type="number" class="edit_input" value="<?php echo e($dulieu->viii_7_tsdtkt); ?>" data_key="viii_7_tsdtkt" min="0">
	        </div>
...
<script type="text/javascript">
   $('.edit_input').on('change',function() {
        ...
        let key = $(this).attr('data_key');
         $.ajax({
            url: "<?php echo route('admin.tudanhgia.database.save_data'); ?>",
            type: "POST",
            data:{
                val : val,
                key : key,
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Database/display_data.blade.php ENDPATH**/ ?>