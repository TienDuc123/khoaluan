<div class="row m-t-lg">
    <div class="col-sm-12">
        <div class="h4 font-bold mb-sm">
            <?php echo app('translator')->get('project/Selfassessment/title.pl7a'); ?>
        </div>
    </div>

    <div class="col-sm-12 m-t-md">
        <p><?php echo app('translator')->get('project/Selfassessment/title.tencsgd'); ?></p>
        <p><?php echo app('translator')->get('project/Selfassessment/title.ma'); ?></p>
        <p><?php echo app('translator')->get('project/Selfassessment/title.tenctdt'); ?>
        <p><?php echo app('translator')->get('project/Selfassessment/title.mactdt'); ?>
    </div>
...
</div><?php /**PATH D:\xampp74\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Selfassessment/hoanthien/phuluc7.blade.php ENDPATH**/ ?>