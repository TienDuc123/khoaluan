    ...
    <div class="form-standard">
        <form id="mc_form" action="<?php echo route('admin.dambaochatluong.manaproof.updateMC'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row pl-4">
                ...
                <div class="col-md-3 d-flex align-items-center justify-content-around" style="display: none">
                    <input type="checkbox" class="form-check-input" hidden name="cong_khai" value="Y" style="margin-left: 40px;"
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamppkhoaluan\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/QualiAssurance/editproof.blade.php ENDPATH**/ ?>