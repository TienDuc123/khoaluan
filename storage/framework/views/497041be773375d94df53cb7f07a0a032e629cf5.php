...
<section class="content-body">
    <h2>
        <?php echo app('translator')->get('project/Selfassessment/title.htkhbc'); ?>
    </h2>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="container-fuild">
                    <h4 class="h4-left"><?php echo app('translator')->get('project/Selfassessment/title.bccv'); ?></h4><br/>
                    <table class="table table-striped table-bordered" id="table" width="100%">
                        <thead>
                            <th width="50"></th>
                            <th><?php echo app('translator')->get('project/Selfassessment/title.tenbc'); ?></th>
                            <th><?php echo app('translator')->get('project/Selfassessment/title.loaitieuchuan'); ?></th>
                            <th><?php echo app('translator')->get('project/Selfassessment/title.nam'); ?></th>
                        </thead>
                        <tbody class="tbodys">
                        </tbody>
                    </table>
...
<script>
    ...
    function selectBC(dat){
        ...
        var name_bc = dat.ten_bc;
         // console.log(dat)
        $.ajax({
            url: "<?php echo route('admin.tudanhgia.detailedplanning.data'); ?>?id=" + dat.id,
            type: 'GET',
            error: function(err) {
            ...
            success: function(data) {
                ...
                if(data.tieuchuan_tieuchi == 0){
                    texto += '<div class="alert alert-warning">' + "<?php echo app('translator')->get('project/Selfassessment/message.alert.kocobctc'); ?>" + '</div>';
                }else{
                    let temp = 0;
                    console.log(data.phan2)
                    texto += data.phan2 ;
                    var name_trangthai = '';
                    var testm = '';
                        ...
                        if(value.mo_ta != null){
                            ...
                            if(value.baoCaoTieuChuan != undefined){
                                if(value.baoCaoTieuChuan.trang_thai_bctc == 'nhanxet'){
                                    ...
                                    name_trangthai = '<i class="fas fa-pen"></i>' + "<?php echo app('translator')->get('project/Selfassessment/title.suabaocao'); ?>";
                                    css_color = 'css_color_organe';

                                    testm = `<a href="<?php echo e(route('admin.tudanhgia.detailedplanning.show')); ?>?id=${value.id_kh_baocao}&tieuchuan_id=${value.tieuchuan_id} " class="${css_trangthai } ${css_color}">`+name_trangthai+ '</a>';
                                    ...
                                    name_trangthai = '<i class="fas fa-eye"></i>' + "<?php echo app('translator')->get('project/Selfassessment/title.xembaocao'); ?>";
                                ...
                                name_trangthai = '<i class="fas fa-pen"></i>' + "<?php echo app('translator')->get('project/Selfassessment/title.vietbc'); ?>"
                                css_color = 'css_color_organe';
                            ...
                            "<span> <?php echo app('translator')->get('project/Selfassessment/title.tc'); ?>" +
    ...
    $(function () {
        table = $('#table').DataTable({
            ...
            serverSide: true,
            searching:false,
            ajax: "<?php echo route('admin.tudanhgia.detailedplanning.data'); ?>",
            order: [],
            columns: [
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\file_moi\xampp\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Selfassessment/planning.blade.php ENDPATH**/ ?>