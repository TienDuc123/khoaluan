...
<section class="content-body bock-body">
    <div class="form-standard">
        ...
        <div class="part-one" style="display: inline-block;">
            ...
            <span ><?php echo app('translator')->get('project/Selfassessment/title.p1'); ?></span>
            ...
            <div id="div_lkh_part_one" style="display:none">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td width="10%">
                            <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.ghtg'); ?>:</label>
                        </td>
                        <td width="10%">
                            <input name="gioihan_start" class="start-date form-control flatpickr flatpickr-input ngaybd_bc" id="gioihan_start" type="text" value="<?php echo e($keHoachBaoCao->ngay_batdau); ?>" disabled/>
                        </td>
                        <td width="10%">
                            <input name="gioihan_end" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_bc" id="gioihan_end" type="text" value="<?php echo e($keHoachBaoCao->ngay_hoanthanh); ?>" disabled/>
                        </td>
                        <td width="10%" align="right">
                            <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.nbd'); ?>:&nbsp;</label>
                        </td>
                        <td width="10%">
                            <input name="ngay_bat_dau" class="start-date form-control flatpickr flatpickr-input ngaybd_chung" id="ngay_bat_dau" type="text" value="<?php echo e(isset($keHoachChung->ngay_batdau)?$keHoachChung->ngay_batdau:''); ?>">
                        </td>
                        <td width="10%" align="right">
                            <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.ngayht'); ?>:</label>
                        </td>
                        <td width="10%">
                            <input name="ngay_ket_thuc" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_chung" id="ngay_ket_thuc" type="text" value="<?php echo e(isset($keHoachChung->ngay_hoanthanh)?$keHoachChung->ngay_hoanthanh:''); ?>">
                        </td>
                        <td width="10%" align="center">
                            <button type="button" class="btn" onclick="update_khaiquat()" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.capnhat'); ?>">
                                <i class="bi bi-upload" style="font-size: 35px;color: #50cd89;"></i>
                            </button>
                        </td>
                    </tr>
                </table>
        ...
        <div class="check_time">
            <button class="part-two border-0">
                ...
                <span><?php echo app('translator')->get('project/Selfassessment/title.p2'); ?></span>
            </button>
            <div >
                <?php $__currentLoopData = $listTc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kh_tieuchuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class="part-two-content">
                        <div class="tieuchuan ml-3">

                            <button class="btn btn-success button_css" id="btn_tieuchuan<?php echo e($kh_tieuchuan->id); ?>" onclick="showhidetieuchi(<?php echo e($kh_tieuchuan->id); ?>);return false;"><i class="fa fa-plus"></i></button>

                            <span class="label label-warning span_css">
                                <i class="fas fa-file"></i>
                            </span>
                            <span>
                                <?php echo app('translator')->get('project/Selfassessment/title.tc'); ?><?php echo e($kh_tieuchuan->stt); ?>:
                                <a><?php echo e($kh_tieuchuan->mo_ta); ?> </a>
                            </span>&nbsp;
                            <span class="daVietBaoCao_<?php echo e($kh_tieuchuan->id); ?> pl-2" d-id=""
                                  d-url="">
                                <i class="fas fa-spinner fa-spin"></i>
                            </span>
                            <button style="float: right;margin-right: 10px;" class="btn btn-warning button_css button_lkh button_tc" id="btn_part_two_<?php echo e($kh_tieuchuan->id); ?>" onclick="showhidepartwo(<?php echo e($kh_tieuchuan->id); ?>);return false;"><i class="fa fa-plus"></i></button>
                        </div>
                        <div id="div_lkh_part_two<?php echo e($kh_tieuchuan->id); ?>" style="width: 97%; display: none;">
                            <br/>
                            <table style="width: 100%; line-height: 36px;">
                                <tr>
                                    <td width="10%">
                                        <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.ghcb'); ?>:</label>
                                    </td>
                                    <td width="10%">
                                        <input name="gioihan_start" class="start-date form-control flatpickr flatpickr-input ngaybd_bc" id="tieuchuan_date_gh_bd_<?php echo e($kh_tieuchuan->id); ?>" type="text" value="<?php echo e($keHoachBaoCao->ngay_batdau_chuanbi); ?>" readonly />
                                    </td>
                                    <td width="10%">
                                        <input name="gioihan_end" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_bc" id="tieuchuan_date_gh_kt_<?php echo e($kh_tieuchuan->id); ?>" type="text" value="<?php echo e($keHoachBaoCao->ngay_hoanthanh_chuanbi); ?>" readonly />
                                    </td>
                                    <td width="10%" align="right">
                                        <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.khcb'); ?>:&nbsp;</label>
                                    </td>
                                    <td width="10%">
                                        <input name="ngay_bat_dau" class="start-date form-control flatpickr flatpickr-input kh_time" id="ngay_chuanbi_<?php echo e($kh_tieuchuan->id); ?>" type="text" >
                                    </td>
                                    <td width="10%">
                                        <input name="ngay_ket_thuc" class="start-date ml-3 form-control flatpickr flatpickr-input kh_time" id="ngay_hoanthanh_<?php echo e($kh_tieuchuan->id); ?>" type="text" >
                                    </td>
                                </tr>
                                <tr>
                                    <td width="10%">
                                        <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.ghbc'); ?>:</label>
                                    </td>
                                    <td width="10%">
                                        <input name="gioihan_start" class="start-date form-control flatpickr flatpickr-input ngaybd_bc" id="tieuchuan_ghbc_bd_<?php echo e($kh_tieuchuan->id); ?>" type="text" value="<?php echo e($keHoachBaoCao->ngay_batdau); ?>" disabled/>
                                    </td>
                                    <td width="10%">
                                        <input name="gioihan_end" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_bc" id="tieuchuan_ghbc_kt_<?php echo e($kh_tieuchuan->id); ?>" type="text" value="<?php echo e($keHoachBaoCao->ngay_hoanthanh); ?>" disabled/>
                                    </td>
                                    <td width="10%" align="right">
                                        <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.khvbc'); ?>:&nbsp;</label>
                                    </td>
                                    <td width="10%">
                                        <input name="ngay_bat_dau" class="start-date form-control flatpickr flatpickr-input kh_time" id="ngay_batdau_vbc_<?php echo e($kh_tieuchuan->id); ?>" type="text" >
                                    </td>
                                    <td width="10%">
                                        <input name="ngay_ket_thuc" class="start-date ml-3 form-control flatpickr flatpickr-input kh_time" id="ngay_hoanthanh_vbc_<?php echo e($kh_tieuchuan->id); ?>" type="text">
                                    </td>
                                </tr>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="form-group d-flex">
                                    <strong class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.nscb'); ?></strong>
                                    <div class="">
                                        <div class="form-control-static">
                                            <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                            data-target="#nhanSuChuanBiModal_<?php echo e($kh_tieuchuan->id); ?>"  data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                    <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                            </button>
                                            <span id="nhanSuChuanBiForm_<?php echo e($kh_tieuchuan->id); ?>"></span>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group d-flex">
                                    <strong class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.nsth'); ?></strong>
                                    <div class="">
                                        <div class="form-control-static">
                                            <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                                    data-target="#nhanSuThucHienModal_<?php echo e($kh_tieuchuan->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                    <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                            </button>
                                            <span id="nhanSuThucHienForm_<?php echo e($kh_tieuchuan->id); ?>"></span>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group d-flex">
                                    <strong class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.nskt'); ?></strong>
                                    <div class="">
                                        <div class="form-control-static">
                                            <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                                    data-target="#nhanSuKiemTraModal_<?php echo e($kh_tieuchuan->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                    <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                            </button>
                                            <span id="nhanSuKiemTraForm_<?php echo e($kh_tieuchuan->id); ?>"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Phân quyền -->
                            ...
                            <div class="form-group d-flex align-items-center">
                                <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.truongnhom'); ?></label>
                                <div class="col-sm-8">
                                    <select name="truongnhom" class="form-control select2_tn" id="truong_nhom_tieuchuan_<?php echo e($kh_tieuchuan->id); ?>">

                                    </select>
                                </div>
                            </div>
                            <!-- <div class="update_all_tieuchuan d-flex align-items-center">
                                <strong><?php echo app('translator')->get('project/Selfassessment/title.capnhatctc'); ?></strong>
                                <input type="checkbox" id = "checkbox_all_<?php echo e($kh_tieuchuan->id); ?>" onclick="checkbox_tieuchuan(<?php echo e($kh_tieuchuan->id); ?>)" style="width: 1.3rem;height: 1.3rem;">
                            </div> -->

                            <br>
                            <div class="d-flex justify-content-center">

                                <button type="button" class="btn" onclick="update_tieuchuan(<?php echo e($kh_tieuchuan->id); ?>)" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.capnhat'); ?>">
                                    <i class="bi bi-upload" style="font-size: 35px;color: #50cd89;"></i>
                                </button>
                                <button type="button" class="btn btn-warning ml-4" onclick="update_all_tieuchuan(<?php echo e($kh_tieuchuan->id); ?>)" id="tieuchuan_all_<?php echo e($kh_tieuchuan->id); ?>" style="display: none;">
                                    <?php echo app('translator')->get('project/Selfassessment/title.capnhatctc'); ?>
                                </button>
                            </div>
                            <br/>
                        </div>
                    </div>
                    <div id="div_tieuchi<?php echo e($kh_tieuchuan->id); ?>" style="display:none">
                        <?php $__currentLoopData = $kh_tieuchuan->tieuchi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tchi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <input type="text" hidden id="tieuchi_id_<?php echo e($kh_tieuchuan->id); ?>" value="<?php echo e($tchi->id); ?>">
                            <div class="part-two-tieuchi part-two-tieuchi_<?php echo e($tchi->id); ?> part-two-tieuchi2_<?php echo e($kh_tieuchuan->id); ?>">
                                <div class="d-flex align-items-center">
                                    <div class="tieuchi ml-4">
                                        <?php if($khbc->writeFollow == 1 || $khbc->writeFollow == 2): ?>
                                            <button class="btn btn-success button_css" id="div_tieuchi-1<?php echo e($tchi->id); ?>" onclick="showhidemenhde(<?php echo e($tchi->id); ?>);updatebosung(<?php echo e($id_kehoach_bc); ?>,<?php echo e($kh_tieuchuan->id); ?>,<?php echo e($tchi->id); ?>);"><i class="fa fa-plus"></i></button>
                                        <?php endif; ?>
                                        ...
                                        <span style="padding-right: 106px;">
                                            <?php echo app('translator')->get('project/Selfassessment/title.tieuchi'); ?> <?php echo e($kh_tieuchuan->stt); ?>.<?php echo e($tchi->stt); ?>:
                                            <a href="#"><?php echo e($tchi->mo_ta); ?></a>

                                            <span class="daVietBaoCao_tieuchi_<?php echo e($tchi->id); ?>" d-id="" d-url="">
                                                <i class="fas fa-spinner fa-spin"></i>
                                            </span>
                                        </span>
                                    ...
                                    <button style="" class="btn btn-warning button_css button_lkh bt_tieuchi btn_part_tieuchi2<?php echo e($kh_tieuchuan->id); ?>" id="btn_part_tieuchi<?php echo e($tchi->id); ?>" onclick="showhidepartieuchi(<?php echo e($tchi->id); ?>,<?php echo e($kh_tieuchuan->id); ?>)"><i class="fa fa-plus"></i></button>
                                </div>

                                <div id="div_lkh_part_tieuchi<?php echo e($tchi->id); ?>" class="div_lkh_part_tieuchi2<?php echo e($kh_tieuchuan->id); ?>" style="width: 97%; display: none;">
                                    <br/>
                                    <table style="width: 100%; line-height: 36px;">
                                        <tr>
                                            <td width="10%">
                                            ...
                                            <td width="10%">
                                                <input name="gioihan_start" class="start-date form-control flatpickr flatpickr-input ngaybd_bc tchi_batdau_chuanbi_<?php echo e($kh_tieuchuan->id); ?>" type="text" disabled/>
                                            </td>
                                            <td width="10%">
                                                <input name="gioihan_end" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_bc tchi_hoanthanh_chuanbi_<?php echo e($kh_tieuchuan->id); ?>" type="text" disabled/>
                                            </td>
                                            <td width="10%" align="right">
                                                <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.khcb'); ?>:&nbsp;</label>
                                            </td>
                                            <td width="10%">
                                                <input name="ngay_bat_dau" class="start-date form-control flatpickr flatpickr-input kh_time" id="ngay_chuanbi_tchi<?php echo e($tchi->id); ?>" type="text">
                                            </td>
                                            <td width="10%">
                                                <input name="ngay_ket_thuc" class="start-date ml-3 form-control flatpickr flatpickr-input kh_time" id="ngay_hoanthanh_tchi<?php echo e($tchi->id); ?>" type="text" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="10%">
                                            ...
                                            <td width="10%">
                                                <input name="gioihan_start" class="start-date form-control flatpickr flatpickr-input ngaybd_bc tchi_batdau_bc_<?php echo e($kh_tieuchuan->id); ?>" id="" type="text" disabled/>
                                            </td>
                                            <td width="10%">
                                                <input name="gioihan_end" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_bc tchi_hoanthanh_bc_<?php echo e($kh_tieuchuan->id); ?>" id="" type="text" disabled/>
                                            </td>
                                            <td width="10%" align="right">
                                                <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.khvbc'); ?>:&nbsp;</label>
                                            </td>
                                            <td width="10%">
                                                <input name="ngay_bat_dau" class="start-date form-control flatpickr flatpickr-input kh_time" id="ngay_batdau_vbc_tchi<?php echo e($tchi->id); ?>" type="text" >
                                            </td>
                                            <td width="10%">
                                                <input name="ngay_ket_thuc" class="start-date ml-3 form-control flatpickr flatpickr-input kh_time" id="ngay_hoanthanh_vbc_tchi<?php echo e($tchi->id); ?>" type="text">
                                            </td>
                                        </tr>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="">
                                                <div class="form-control-static d-flex align-items-center">
                                                    <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                                            data-target="#nhanSuChuanBiModal_tchi_<?php echo e($tchi->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                            <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                                    </button>
                                                    <p id="nhanSuChuanBiForm_tchi_<?php echo e($tchi->id); ?>" style="margin: 0;"></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="">
                                                <div class="form-control-static d-flex align-items-center">
                                                    <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                                            data-target="#nhanSuThucHienModal_tchi_<?php echo e($tchi->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                            <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                                    </button>
                                                    <p id="nhanSuThucHienForm_tchi_<?php echo e($tchi->id); ?>" style="margin: 0;"></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="">
                                                <div class="form-control-static d-flex align-items-center">
                                                    <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                                            data-target="#nhanSuKiemTraModal_tchi_<?php echo e($tchi->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                            <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                                    </button>
                                                    <p id="nhanSuKiemTraForm_tchi_<?php echo e($tchi->id); ?>" style="margin: 0;"></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group d-flex">
                                        <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.truongnhom'); ?></label>
                                        <div class="col-sm-8">
                                            <select name="truongnhom" id="truong_nhom_tieuchi_<?php echo e($tchi->id); ?>" class="form-control select2 ">

                                            </select>
                                        </div>
                                    </div>
                                   <!--  <div class="d-flex align-items-center">
                                        <strong><?php echo app('translator')->get('project/Selfassessment/title.capnhatcmdvtc'); ?></strong>
                                        <input type="checkbox" id = "checkbox_tieuchi_<?php echo e($tchi->id); ?>" onclick="checkbox_tieuchi(<?php echo e($tchi->id); ?>,<?php echo e($kh_tieuchuan->id); ?>) " style="width: 1.3rem;height: 1.3rem;">
                                    </div> -->
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn" onclick="update_tieuchi(<?php echo e($tchi->id); ?>,<?php echo e($kh_tieuchuan->id); ?>)" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.capnhat'); ?>">
                                            <i class="bi bi-upload" style="font-size: 35px;color: #50cd89;"></i>
                                        </button>
                                        <button type="button" id="tieuchi_all_<?php echo e($tchi->id); ?>" class="btn btn-warning ml-4" onclick="update_tieuchi_all(<?php echo e($tchi->id); ?>,<?php echo e($kh_tieuchuan->id); ?>)" style="display: none;">
                                            <?php echo app('translator')->get('project/Selfassessment/title.capnhatcmdctcn'); ?>
                                        </button>
                                    </div>
                                    <br/>
                                </div>
                            </div>
                            <div id="div_menhde<?php echo e($tchi->id); ?>" style="display:none">
                                <?php if($khbc->writeFollow == 1): ?>
                                    <?php $__currentLoopData = $tchi->menhde; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $md): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="part-two-menhde_<?php echo e($md->id); ?> part-two-menhde_css part-two-menhde2_<?php echo e($kh_tieuchuan->id); ?> part-two-menhde3_<?php echo e($tchi->id); ?>">
                                                <div class="d-flex align-items-center">
                                                    <div class="menhde ml-5 menhde_css">
                                                        <a href="#">
                                                            <?php echo app('translator')->get('project/Selfassessment/title.chibao'); ?> <?php echo e($md->stt); ?>: <?php echo e($md->mo_ta); ?>

                                                        </a>

                                                          <span class="daVietBaoCao_menhde_<?php echo e($md->id); ?>" d-id="" d-url="">
                                                                <i class="fas fa-spinner fa-spin"></i>
                                                          </span>
                                                    </div>


                                                    <button style="" class="btn btn-warning button_css button_lkh bt_tieuchi btn_part_menhde2_<?php echo e($kh_tieuchuan->id); ?> btn_part_menhde3_<?php echo e($tchi->id); ?>" id="btn_part_menhde_<?php echo e($md->id); ?>" onclick="showhideparmenhde(<?php echo e($md->id); ?>,<?php echo e($tchi->id); ?>,<?php echo e($kh_tieuchuan->id); ?>)"><i class="fa fa-plus"></i></button>
                                                </div>
                                                <div id="div_lkh_part_menhde<?php echo e($md->id); ?>" style="width: 97%; display: none; padding-left: 58px ;" class="div_lkh_part_menhde2<?php echo e($kh_tieuchuan->id); ?> div_lkh_part_menhde3<?php echo e($tchi->id); ?>">
                                                    <br/>
                                                    <table style="width: 100%; line-height: 36px;">
                                                        <tr>
                                                            <td width="10%">
                                                            ...
                                                            <td width="10%">
                                                                <input name="gioihan_start" class="start-date form-control flatpickr flatpickr-input ngaybd_md_gh_<?php echo e($tchi->id); ?>" id="gioihan_start_menhde" type="text" disabled/>
                                                            </td>
                                                            <td width="10%">
                                                                <input name="gioihan_end" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_md_gh_<?php echo e($tchi->id); ?>" id="gioihan_end_menhde" type="text" disabled/>
                                                            </td>
                                                            <td width="10%" align="right">
                                                                <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.nbd'); ?>:&nbsp;</label>
                                                            </td>
                                                            <td width="10%">
                                                                <input name="ngay_bat_dau" class="start-date form-control flatpickr flatpickr-input ngaybd_menhde_<?php echo e($md->id); ?>" id="ngay_bat_dau" type="text">
                                                            </td>
                                                            <td width="10%" align="right">
                                                                <label class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.ngayht'); ?>:</label>
                                                            </td>
                                                            <td width="10%">
                                                                <input name="ngay_ket_thuc" class="start-date ml-3 form-control flatpickr flatpickr-input ngayht_menhde_<?php echo e($md->id); ?>" id="ngay_ket_thuc" type="text">
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <div class="d-flex justify-content-around">
                                                        ...
                                                        <div class="form-group d-flex">
                                                            ...
                                                            <div class="">
                                                                <div class="form-control-static d-flex align-items-center">
                                                                    <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                                                            data-target="#nhanSuThucHienModal_menhde_<?php echo e($md->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                                            <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                                                    </button>
                                                                    <p id="nhanSuThucHienForm_menhde_<?php echo e($md->id); ?>" style="margin: 0;"></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- <input type="checkbox" id = "checkbox_menhde_<?php echo e($md->id); ?>" onclick="checkbox_menhde(<?php echo e($md->id); ?>)"> -->
                                                        <div class="form-group d-flex">
                                                            <strong class="control-label"><?php echo app('translator')->get('project/Selfassessment/title.nskt'); ?></strong>
                                                            <div class="">
                                                                <div class="form-control-static d-flex align-items-center">
                                                                    <button class="btn btn-xs pd-css" data-toggle="modal" type="button"
                                                                            data-target="#nhanSuKiemTraModal_menhde_<?php echo e($md->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.xemdanhsach'); ?>">
                                                                            <i class="bi bi-person-lines-fill" style="font-size: 35px;color: #5014d0;"></i>
                                                                    </button>
                                                                    <p id="nhanSuKiemTraForm_menhde_<?php echo e($md->id); ?>" style="margin: 0;"></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <br>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn" onclick="update_menhde(<?php echo e($md->id); ?>,<?php echo e($tchi->id); ?>)" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Selfassessment/title.capnhat'); ?>">
                                                            <i class="bi bi-upload" style="font-size: 35px;color: #50cd89;"></i>
                                                        </button>
                                                    </div>
                                                    <br/>
                                            ...
                                            <div class="modal inmodal fade" id="nhanSuThucHienModal_menhde_<?php echo e($md->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header d-flex flex-row-reverse">
                                                            ...
                                                            <h4 class="modal-title"><?php echo app('translator')->get('project/Selfassessment/title.nsth'); ?></h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row">

                                                                <div class="col-lg-5">
                                                                    <div class="list-group exchangeList_mende_th_<?php echo e($md->id); ?>" data-target="#nhanSuThucHienAll_menhde_<?php echo e($md->id); ?>"
                                                                         id="nhanSuThucHienList_menhde_<?php echo e($md->id); ?>" d-form="#nhanSuThucHienForm_menhde_<?php echo e($md->id); ?>" d-name="ns_thuchien">
                                                                ...
                                                                <div class="col-lg-5">
                                                                    <div class="list-group exchangeList_mende_th_<?php echo e($md->id); ?>" data-target="#nhanSuThucHienList_menhde_<?php echo e($md->id); ?>"
                                                                         id="nhanSuThucHienAll_menhde_<?php echo e($md->id); ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-white" data-dismiss="modal"><?php echo app('translator')->get('project/Selfassessment/title.dong'); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal inmodal fade" id="nhanSuKiemTraModal_menhde_<?php echo e($md->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header d-flex flex-row-reverse">
                                                        <button type="button" class="close" data-dismiss="modal">
                                                        ...
                                                        <h4 class="modal-title"><?php echo app('translator')->get('project/Selfassessment/title.nskt'); ?></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="row">

                                                            <div class="col-lg-5">
                                                                <div class="list-group exchangeList_mende_kt_<?php echo e($md->id); ?>" data-target="#nhanSuKiemTraAll_menhde_<?php echo e($md->id); ?>"
                                                                     id="nhanSuKiemTraList_menhde_<?php echo e($md->id); ?>" d-form="#nhanSuKiemTraForm_menhde_<?php echo e($md->id); ?>" d-name="ns_kiemtra">
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="list-group exchangeList_mende_kt_<?php echo e($md->id); ?>" data-target="#nhanSuKiemTraList_menhde_<?php echo e($md->id); ?>"
                                                                     id="nhanSuKiemTraAll_menhde_<?php echo e($md->id); ?>">
                                    ...
                                    <?php $__currentLoopData = $tchi->menhde; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $md): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="part-two-menhde_<?php echo e($md->id); ?> part-two-menhde_css part-two-menhde2_<?php echo e($kh_tieuchuan->id); ?> part-two-menhde3_<?php echo e($tchi->id); ?>">
                                                <div class="d-flex align-items-center">
                                                    <div class="menhde ml-5 menhde_css">
                                                        <a href="#">
                                                            <?php echo app('translator')->get('project/Selfassessment/title.mocchuan'); ?> <?php echo e($index++); ?>: <?php echo e($md->mo_ta); ?>
                            ...
                            <div class="modal inmodal fade" id="nhanSuChuanBiModal_tchi_<?php echo e($tchi->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header d-flex flex-row-reverse">
                                            <button type="button" class="close" data-dismiss="modal">
                                            ...
                                            <h4 class="modal-title"><?php echo app('translator')->get('project/Selfassessment/title.nscb'); ?></h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">

                                                <div class="col-lg-5">
                                                    <div class="list-group exchangeList_tchi_cb<?php echo e($tchi->id); ?>" data-target="#nhanSuChuanBiAll_tchi_<?php echo e($tchi->id); ?>"
                                                         id="nhanSuChuanBiList_tchi_<?php echo e($tchi->id); ?>" d-form="#nhanSuChuanBiForm_tchi_<?php echo e($tchi->id); ?>" d-name="ns_chuanbi">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="list-group exchangeList_tchi_cb<?php echo e($tchi->id); ?>" data-target="#nhanSuChuanBiList_tchi_<?php echo e($tchi->id); ?>"
                                                         id="nhanSuChuanBiAll_tchi_<?php echo e($tchi->id); ?>">
                            ...
                            <div class="modal inmodal fade" id="nhanSuThucHienModal_tchi_<?php echo e($tchi->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header d-flex flex-row-reverse">
                                            <button type="button" class="close" data-dismiss="modal">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="list-group exchangeList_tchi_th<?php echo e($tchi->id); ?>" data-target="#nhanSuThucHienAll_tchi_<?php echo e($tchi->id); ?>"
                                                         id="nhanSuThucHienList_tchi_<?php echo e($tchi->id); ?>" d-form="#nhanSuThucHienForm_tchi_<?php echo e($tchi->id); ?>" d-name="ns_thuchien">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="list-group exchangeList_tchi_th<?php echo e($tchi->id); ?>" data-target="#nhanSuThucHienList_tchi_<?php echo e($tchi->id); ?>"
                                                         id="nhanSuThucHienAll_tchi_<?php echo e($tchi->id); ?>">
                            ...
                            <div class="modal inmodal fade" id="nhanSuKiemTraModal_tchi_<?php echo e($tchi->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header d-flex flex-row-reverse">
                                            <button type="button" class="close" data-dismiss="modal">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="list-group exchangeList_tchi_kt<?php echo e($tchi->id); ?>" data-target="#nhanSuKiemTraAll_tchi_<?php echo e($tchi->id); ?>"
                                                         id="nhanSuKiemTraList_tchi_<?php echo e($tchi->id); ?>" d-form="#nhanSuKiemTraForm_tchi_<?php echo e($tchi->id); ?>" d-name="ns_kiemtra">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="list-group exchangeList_tchi_kt<?php echo e($tchi->id); ?>" data-target="#nhanSuKiemTraList_tchi_<?php echo e($tchi->id); ?>"
                                                         id="nhanSuKiemTraAll_tchi_<?php echo e($tchi->id); ?>">
                ...
                <div class="modal inmodal fade" id="nhanSuChuanBiModal_<?php echo e($kh_tieuchuan->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header d-flex flex-row-reverse">
                                <button type="button" class="close" data-dismiss="modal">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="list-group exchangeList_cb_tieuchuan exchangeList_cb_<?php echo e($kh_tieuchuan->id); ?>" data-target="#nhanSuChuanBiAll_<?php echo e($kh_tieuchuan->id); ?>"
                                             id="nhanSuChuanBiList_<?php echo e($kh_tieuchuan->id); ?>" d-form="#nhanSuChuanBiForm_<?php echo e($kh_tieuchuan->id); ?>" d-name="ns_chuanbi">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="list-group exchangeList_cb_tieuchuan exchangeList_cb_<?php echo e($kh_tieuchuan->id); ?>" data-target="#nhanSuChuanBiList_<?php echo e($kh_tieuchuan->id); ?>"
                                             id="nhanSuChuanBiAll_<?php echo e($kh_tieuchuan->id); ?>">
                ...
                <!-- modal nhân sự thực hiện -->
                <div class="modal inmodal fade" id="nhanSuThucHienModal_<?php echo e($kh_tieuchuan->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header d-flex flex-row-reverse">
                                <button type="button" class="close" data-dismiss="modal">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="list-group exchangeList_th_<?php echo e($kh_tieuchuan->id); ?>" data-target="#nhanSuThucHienAll_<?php echo e($kh_tieuchuan->id); ?>"
                                             id="nhanSuThucHienList_<?php echo e($kh_tieuchuan->id); ?>" d-form="#nhanSuThucHienForm_<?php echo e($kh_tieuchuan->id); ?>" d-name="ns_thuchien">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div class="list-group exchangeList_th_<?php echo e($kh_tieuchuan->id); ?>" data-target="#nhanSuThucHienList_<?php echo e($kh_tieuchuan->id); ?>"
                                             id="nhanSuThucHienAll_<?php echo e($kh_tieuchuan->id); ?>">
                ...
                <!-- modal nhân sự kiểm tra -->
                <div class="modal inmodal fade" id="nhanSuKiemTraModal_<?php echo e($kh_tieuchuan->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header d-flex flex-row-reverse">
                                <button type="button" class="close" data-dismiss="modal">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="list-group exchangeList_kt_<?php echo e($kh_tieuchuan->id); ?>" data-target="#nhanSuKiemTraAll_<?php echo e($kh_tieuchuan->id); ?>"
                                             id="nhanSuKiemTraList_<?php echo e($kh_tieuchuan->id); ?>" d-form="#nhanSuKiemTraForm_<?php echo e($kh_tieuchuan->id); ?>" d-name="ns_kiemtra">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="list-group exchangeList_kt_<?php echo e($kh_tieuchuan->id); ?>" data-target="#nhanSuKiemTraList_<?php echo e($kh_tieuchuan->id); ?>"
                                             id="nhanSuKiemTraAll_<?php echo e($kh_tieuchuan->id); ?>">
        ...
        <div >
            <div class="part-three" data-toggle="modal" data-target="">
                ...
                <span><?php echo app('translator')->get('project/Selfassessment/title.p3'); ?></span>
        </div>
    </div>
</section>
    ...
    <div class="modal-content">
      <div class="modal-header d-flex flex-row-reverse">
        <h5 class="modal-title" id="modalKqKlLabel">
            <?php echo app('translator')->get('project/Selfassessment/title.lkhp1p3'); ?>
        </h5>
      ...
      <form action="" method="post">
        <?php echo csrf_field(); ?>
          <div class="modal-body">
                <p>
                    <?php echo app('translator')->get('project/Selfassessment/title.kehoach'); ?>:
                    <?php echo e($khbc->ten_bc); ?>

                </p>
                <p class="block-flex">
                    <?php echo app('translator')->get('project/Selfassessment/title.ghtg'); ?>:
                    <span class="block-flex">
                        <input name="gioihan_start" class="start-date form-control flatpickr flatpickr-input" id="gioihan_start" type="text" value="<?php echo e($keHoachBaoCao->ngay_batdau); ?>">
                        <input name="gioihan_end" class="start-date ml-3 form-control flatpickr flatpickr-input" id="gioihan_end" type="text" value="<?php echo e($keHoachBaoCao->ngay_hoanthanh); ?>">
                    </span>
                </p>
                <p class="block-flex">
                    <?php echo app('translator')->get('project/Selfassessment/title.nbd'); ?>:
...
<script>
    ...
    var khbc_id = <?php echo e($khbc->id); ?>;
    var listkhtchuan = {};
    var listkhtchi = {};
    ...
    function load_tieuchuan(data, tieuchuan_id){
        ...
        nhanSuChuanBiAll.append(`
                                    <li class="list-group-item active font-bold">
                                        <?php echo app('translator')->get('project/Selfassessment/title.danhsachnhansu'); ?>
                                    </li>
                                `
                                );
    ...
    function showhidepartwo(tieuchuan_id){
        ...
        if($('#div_lkh_part_two'+tieuchuan_id).is(':visible')){
            ...
            $.ajax({
                url: "<?php echo e(route('admin.tudanhgia.report.datadetail')); ?>",
                type: "POST",
                _token: '<?php echo e(csrf_token()); ?>',
                data:{
                    khbc_id : <?php echo e($id_kehoach_bc); ?>,
                ...
                success: function(data) {
                    if(data == 0){
                        alert(`<?php echo app('translator')->get('project/Selfassessment/title.danhsachnhansu'); ?>`);
                    }else{
                        if(data != undefined){
        ...
        if($('#div_lkh_part_tieuchi'+tieuchi_id).is(':visible')){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data == 0){
                        alert(`<?php echo app('translator')->get('project/Selfassessment/title.kcdlkhtchi'); ?>`);
                    }else{
                        // console.log(data);
        ...
        if($('#div_lkh_part_menhde'+menhde_id).is(':visible')){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data == 0){
                        alert(`<?php echo app('translator')->get('project/Selfassessment/title.kcdlkhmenhde'); ?>`);
                    }else{
                        var id_nsth_menhde = [];
                        var id_nsth_kiemtra = [];
    ...
    function update_khaiquat(){
        let id_khbc = <?php echo e($keHoachBaoCao->id); ?>;
        let ngay_batdau_chung = $('.ngaybd_chung').val();
        let ngay_hoanthanh_chung = $('.ngayht_chung').val();

        $.ajax({
                url: "<?php echo e(route('admin.tudanhgia.report.upadate_kq')); ?>",
                type: "GET",
                data:{
                    id_khbc : id_khbc,
                ...
                success: function(data) {
                    if(data == 1){
                        ...
                        alert(`<?php echo app('translator')->get('project/Selfassessment/title.capnhatkhl'); ?>`);
                    }
    ...
    function update_tieuchuan(tc_id){
        ...
        $.ajax({
                url: "<?php echo e(route('admin.tudanhgia.report.upadate_tieuchuan')); ?>",
                type: "GET",
                data:{
    ...
    function check_start(){
        $.ajax({
                url: "<?php echo e(route('admin.tudanhgia.report.star_tieuchuan')); ?>?id=<?php echo e($id_kehoach_bc); ?>&botieuchuan=<?php echo e($khbc->bo_tieuchuan_id); ?>",
                type: "GET",
                error: function(err) {
    ...
    function update_tieuchi(tieuchi_id,tieuchuan_id){
        ...
        let id_khbc = <?php echo e($keHoachBaoCao->id); ?>;
        $.ajax({
                url: "<?php echo e(route('admin.tudanhgia.report.upadate_tieuchi')); ?>",
                type: "GET",
                data:{
    ...
    function update_menhde(menhde_id,tieuchi_id){
        ...
        $.ajax({
                url: "<?php echo e(route('admin.tudanhgia.report.upadate_menhde')); ?>",
                type: "GET",
                data:{
    ...
    function updatebosung(id_khbc,id_tieuchuan,id_tieuchi){
        $.ajax({
                url: "<?php echo e(route('admin.tudanhgia.report.updatebosung')); ?>",
                type: "POST",
                data:{
                    id_khbc : id_khbc,
                    id_tieuchuan : id_tieuchuan,
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Selfassessment/plandetail.blade.php ENDPATH**/ ?>