...
<section class="content-body">
    <div class="block-flex">
        ...
        <a href="<?php echo e(route('admin.tudanhgia.preparereport.proofHandGroup')); ?>" class="btn btn-danger">
            <?php echo app('translator')->get('project/Selfassessment/title.xlmc'); ?>
        </a>
    </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamppkhoaluan\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Selfassessment/proofhandling.blade.php ENDPATH**/ ?>