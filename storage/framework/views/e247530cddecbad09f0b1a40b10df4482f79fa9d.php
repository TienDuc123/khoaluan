<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('project/Standard/title.tltchi'); ?>
...
<section class="content-body">
    <div class="form-standard">
        <h4><?php echo app('translator')->get('project/Standard/title.tbtc'); ?></h4>
        <div class="create-standard">
            <input type="text" placeholder="<?php echo app('translator')->get('project/Standard/title.tbtc'); ?>" class="form-control" disabled value="<?php echo e($btc_name); ?>">
            <select class="form-control" disabled>
                <option value="ctdt">CTĐT</option>
            </select>
        </div>
        <h4><?php echo app('translator')->get('project/Standard/title.tchuan_tchi'); ?></h4>
        <form action="<?php echo e(route('admin.thuongtruc.setstandard.upCriteria')); ?>" method="post" class="create-standard">
            <?php echo csrf_field(); ?>
            <select class="form-control" disabled>
                <option hidden><?php echo app('translator')->get('project/Standard/title.tieuchuan'); ?></option>
                <option value="<?php echo e($tc_name); ?>" selected>
                    <?php echo e($tc_name); ?>

                </option>
            </select>

            <input type="hidden" name="id_tchi" value="<?php echo e($id_tchi); ?>">
            <input class="form-control" type="text" name="nameTchi" value="<?php echo e($tchi_name); ?>">
            <button class="btn ">
                <i class="bi bi-save" style="font-size: 35px;color: #50cd89;;" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Standard/title.upTChi'); ?>"></i>
            </button>
        </form>
        ...
        <div class="content-page">
            <div class="wrapper-tabs">
                ...
                <div id="tab-1" class="tab-content current">
                    <form action="<?php echo e(route('admin.thuongtruc.setstandard.createBenchmark')); ?>" method="POST" id="form-slmc">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" value="<?php echo e($id_tchi); ?>" name="id_tchi">
                        <div class="item-group first-item">
                            <span class="mr-4"><?php echo app('translator')->get('project/Standard/title.slmc'); ?></span>
                        ...
                        <div class="item-group-button">
                            <button id="btn-cancel-slmc" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Standard/title.huy'); ?>">
                                <i class="bi bi-x-circle" style="font-size: 30px;color: red;"></i>
                            </button>
                            <button id="btn-save-slmc" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Standard/title.luu'); ?>">
                                <i class="bi bi-save" style="font-size: 30px;color: #50cd89;"></i>
                            </button>
                        </div>
                    </form>

                    <h4 class="mt-5"><?php echo app('translator')->get('project/Standard/title.qlmocchuan'); ?></h4>
                    <table class="table table-striped table-bordered" id="table" width="100%">
                        <thead>
                         <tr>
                            <th ><?php echo app('translator')->get('project/Standard/title.ndmc'); ?></th>
                            <th ><?php echo app('translator')->get('project/Standard/title.giatri'); ?></th>
                            <th ><?php echo app('translator')->get('project/Standard/title.trongso'); ?></th>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUpdateLabel">
                    <?php echo app('translator')->get('project/Standard/title.csmc'); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?php echo e(route('admin.thuongtruc.setstandard.updateMocchuan')); ?>">
                <input type="hidden" value="id_mch" id="id_mch" name="id_mch">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="inputNdmc">
                            <?php echo app('translator')->get('project/Standard/title.ndmc'); ?>
                        </label>
                        <input type="text" class="form-control h-2rem" id="inputNdmc" placeholder="<?php echo app('translator')->get('project/Standard/title.ndmc'); ?>" required name="inputNdmc">
                    </div>
                    <div class="form-group">
                        <label for="inputGiatri">
                            <?php echo app('translator')->get('project/Standard/title.giatri'); ?>
                        </label>
                        <input type="number" class="form-control h-2rem" id="inputGiatri" placeholder=" <?php echo app('translator')->get('project/Standard/title.giatri'); ?>"  name="inputGiatri">
                    </div>
                    <div class="form-group">
                        <label for="inputTrongso">
                            <?php echo app('translator')->get('project/Standard/title.trongso'); ?>
                        </label>
                        <input type="number" class="form-control h-2rem" id="inputTrongso" placeholder=" <?php echo app('translator')->get('project/Standard/title.trongso'); ?>"  name="inputTrongso">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">
                        <?php echo app('translator')->get('project/Standard/title.tdmc'); ?>
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUpdateCbLabel">
                    <?php echo app('translator')->get('project/Standard/title.cscb'); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?php echo e(route('admin.thuongtruc.setstandard.updateChibao')); ?>">
                <input type="hidden" id="id_chibao" name="id_chibao">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="up_inputNdcb">
                            <?php echo app('translator')->get('project/Standard/title.ndcb'); ?>
                        </label>
                        <textarea class="form-control" id="up_inputNdcb" placeholder="<?php echo app('translator')->get('project/Standard/title.ndcb'); ?>" name="ndcb" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="up_inputTk">
                            <?php echo app('translator')->get('project/Standard/title.tukhoa'); ?>
                        </label>
                        <input type="text" class="form-control h-2rem" id="up_inputTk" placeholder="<?php echo app('translator')->get('project/Standard/title.tukhoa'); ?>" required name="tukhoa">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="up_inputKtmc">
                                    <?php echo app('translator')->get('project/Standard/title.ktmc'); ?>
                                </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="up_inputKttp">
                                    <?php echo app('translator')->get('project/Standard/title.kttp'); ?>
                                </label>
                    ...
                    <div class="form-group">
                        <label for="up_inputGioihan">
                            <?php echo app('translator')->get('project/Standard/title.gioihan'); ?>
                        </label>
                        <input type="number" id="up_inputGioihan" class="form-control h-2rem" placeholder="<?php echo app('translator')->get('project/Standard/title.gioihan'); ?>" name="gioihan">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">
                        <?php echo app('translator')->get('project/Standard/title.tdcb'); ?>
                    </button>
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    $(function(){
        table = $('#table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "<?php echo route('admin.thuongtruc.setstandard.dataMocchuan'); ?>"  + "?id_tchi="
                    + '<?php echo e($id_tchi); ?>',
            columns: [
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        var route = "<?php echo e(route('admin.thuongtruc.setstandard.deleteMocchuan')); ?>" + "?id_delete=" + id;
        var modal = $(this);
    ...
    $('#modalUpdate').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget)
        var id = button.data('id')
        var route = "<?php echo e(route('admin.thuongtruc.setstandard.getDataMocchuan')); ?>" +
                    "?id_mc=" + id;
        fetch(route, {
            headers: {
...
<script type="text/javascript">
    var ndmc = "<?php echo app('translator')->get('project/Standard/title.ndmc'); ?>";
    var giatri = "<?php echo app('translator')->get('project/Standard/title.giatri'); ?>";
    var trongso = "<?php echo app('translator')->get('project/Standard/title.trongso'); ?>";
    var slmc = 0;
    ...
    $("#btn-save-slmc").click(function() {
        ...
        if(checkSubmit() && !check){
            ...
            alert("<?php echo app('translator')->get('project/Standard/title.ttbths'); ?>")
        }
    })
...
<!-- JS chỉ báo -->
<script type="text/javascript">
    var content = "<?php echo app('translator')->get('project/Standard/title.content'); ?>";
    var slmctt = 0;
        ...
        let tcrow = `
            <div class="mt-4">
                <div class="item-group">
                    ...
                    <input type="text" class="form-control ml-4 mr-4 w-20 group-tukhoa-2" placeholder="<?php echo app('translator')->get('project/Standard/title.tukhoa'); ?>" name="tukhoa[]">
                    <div align="center">
                    ...
                    <input type="number" class="form-control ml-4 mr-4 w-20 group-gioihan-2" placeholder="<?php echo app('translator')->get('project/Standard/title.gioihan'); ?>" name="gioihan[]">
    ...
    //         $("#form-slmctt").submit();
    //     else
    //         alert("<?php echo app('translator')->get('project/Standard/title.tttcb'); ?>");
    // })



    $("#btn-save-slmctt").click(function() {
        let check = document.querySelectorAll(".group-content-2").length == 0;
        if(checkSubmit2() && !check){
            $("#form-slmctt").submit();
        }else{
            alert("<?php echo app('translator')->get('project/Standard/title.tttcb'); ?>")
        }
...
<script type="text/javascript">
    $(function(){
        table2 = $('#table2').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "<?php echo route('admin.thuongtruc.setstandard.dataChibao'); ?>"  + "?id_tchi="
                    + '<?php echo e($id_tchi); ?>',
            columns: [
                { data: 'mo_ta', name: 'mo_ta' },
    ...
    $('#modalDeleteCb').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget)
        var id = button.data('id')
        var route = "<?php echo e(route('admin.thuongtruc.setstandard.deleteChibao')); ?>" + "?id_delete=" + id;
        var modal = $(this);
    ...
    $('#modalUpdateCb').on('show.bs.modal', function (event) {
        ...
        var id = button.data('id')
        $("#id_chibao").val(id)
        var route = "<?php echo e(route('admin.thuongtruc.setstandard.dataChibao')); ?>" +
                    "?id_cb=" + id;
        fetch(route, {
            headers: {
                'Content-Type': 'application/json',
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamppkhoaluan\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Standard/create_benchmark.blade.php ENDPATH**/ ?>