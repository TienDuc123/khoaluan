<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('project/QualiAssurance/title.lkh'); ?>
...
<section class="content-body">
    <div class="container-fuild">
        <div class="row">
            <h2 class="col-md-12">
                <?php echo app('translator')->get('project/QualiAssurance/title.khdbcln' ); ?>
            </h2>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <select id="namlkh" class="form-control">
                        <option value="" hidden>-- <?php echo app('translator')->get('project/QualiAssurance/title.cnlkh'); ?></option>
                        <?php for($i = intVal(date('Y')) + 1 ;$i >= 2017; $i--): ?>
                ...
                <div class="col-md-4">
                    <select id="namcopykh" class="form-control">
                        <option value="" hidden>-- <?php echo app('translator')->get('project/QualiAssurance/title.cncopykh'); ?></option>
                ...
                <div class="col-md-1">
                    <button class="btn btn-benchmark mr-2" type="button" id="turnOnmodalCopy" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/QualiAssurance/title.copykhtnc'); ?>">
                        <i class="bi bi-plus-square" style="font-size: 35px;color: red;"></i>
                    </button>
                </div>
                <div class="col-md-1">
                    <button type="button" class="btn" data-toggle="modal" data-target="#modalLapKeHoach" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/QualiAssurance/title.lkhm'); ?>">
                        <i class="bi bi-file-earmark-plus-fill"  style="font-size: 35px;color: #009ef7;"></i> 
                    </button>
                </div>
                
                <div class="col-md-1">
                    <a class="btn btn-benchmark mr-2" href="<?php echo e(route('admin.dambaochatluong.planning.exportplaning')); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/QualiAssurance/title.xuat_excel'); ?>">
    ...
    <div class="form-standard">
            ...
            <div class="wrapper-tabs">
                <ul class="tabs">
                    <li class="tab-link current" data-tab="tab-1">
                        <?php echo app('translator')->get('project/QualiAssurance/title.dlkh'); ?>
                    </li>
                    <li class="tab-link" data-tab="tab-2">
                        <?php echo app('translator')->get('project/QualiAssurance/title.clkh'); ?>
                    </li>
                </ul>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <select class="form-control item-search years">
                                    <option value="">
                                        -- <?php echo app('translator')->get('project/QualiAssurance/title.chonnam'); ?>
                                    </option>
                                    <?php for($i = intVal(date('Y')) + 1 ;$i >= 2017; $i--): ?>
                                        <option 
                                            <?php if($i == intVal(date('Y'))): ?>
                                                selected 
                                            <?php endif; ?>
                                        ><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                            ...
                            <div class="col-md-3">
                                <select class="form-control item-search mcsl">
                                    <option value="">
                                        -- <?php echo app('translator')->get('project/QualiAssurance/title.chonlv'); ?>
                                    </option>
                            ...
                            <div class="col-md-3">
                                <select class="form-control item-search donvi">
                                    <option value="">
                                        -- <?php echo app('translator')->get('project/QualiAssurance/title.chondv'); ?>
                                    </option>
                    ...
                    <table class="table table-striped table-bordered" id="table" width="100%">
                        <thead>
                         <tr>
                            ...
                            <th ><?php echo app('translator')->get('project/QualiAssurance/title.nbd'); ?></th>
                            <th ><?php echo app('translator')->get('project/QualiAssurance/title.nht'); ?></th>
                            <th ><?php echo app('translator')->get('project/QualiAssurance/title.dvpt'); ?></th>
                            <th ><?php echo app('translator')->get('project/QualiAssurance/title.nskt'); ?></th>
                            <th ><?php echo app('translator')->get('project/QualiAssurance/title.notes'); ?></th>
                            <?php if(Sentinel::inRole('admin') || Sentinel::inRole('operator')): ?>
                                <th ><?php echo app('translator')->get('project/QualiAssurance/title.hdong'); ?></th>
                            <?php endif; ?>
                         </tr>
                        </thead>
                        <tbody>  
        ...
        <!-- <div class="item-group-button right-block mb-2 mt-3">
            <button class="btn btn-success btn-benchmark mr-2" type="button">
                ...
                <span><?php echo app('translator')->get('project/QualiAssurance/title.cnkh'); ?></span>
            </button>
        </div> -->
    </div>
</section>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLapKeHoachLabel">
            <?php echo app('translator')->get('project/QualiAssurance/title.lkhm'); ?>
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?php echo e(route('admin.dambaochatluong.planning.createPlan')); ?>" method="post" id="form-add-kehoach">
            <?php echo csrf_field(); ?>
          <div class="modal-body">
            <div class="container-fuild">
                <div class="row">
                    <div class="col-md-6">
                        <label><?php echo app('translator')->get('project/QualiAssurance/title.chonlv'); ?></label>
                        <select class="form-control item-search mcsl-new" name="linhvuc" id="select-linhvuc">
                            <option value="">
                                -- <?php echo app('translator')->get('project/QualiAssurance/title.chonlv'); ?>
                            </option>
                            <?php $__currentLoopData = $linh_vuc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="cre_start_time">
                            <?php echo app('translator')->get('project/QualiAssurance/title.ngaybd'); ?>
                        </label>
                        <input name="startDate" class="form-control flatpickr flatpickr-input" id="cre_start_time" data-mindate="today" type="text" placeholder="<?php echo app('translator')->get('project/QualiAssurance/title.tgth'); ?>" >
                    </div>
                    <div class="col-md-6">
                        <label for="cre_end_time">
                            <?php echo app('translator')->get('project/QualiAssurance/title.nht'); ?>
                        </label>
                        <input name="endDate" class="form-control flatpickr flatpickr-input" data-mindate="today" id="cre_end_time" type="text" placeholder="<?php echo app('translator')->get('project/QualiAssurance/title.nht'); ?>">
                    </div>
                    <div class="col-md-6">
                        <label>
                            <?php echo app('translator')->get('project/QualiAssurance/title.dvpt'); ?>
                        </label>
                        <select name="dvpt" class="form-control item-search donvi" id="select-donvi">
                            <option hidden value="">
                                ---- <?php echo app('translator')->get('project/QualiAssurance/title.chondvpt'); ?>
                            </option>
                            <?php $__currentLoopData = $loai_dv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ldv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <optgroup label="<?php echo e($ldv->loai_donvi); ?>">
                                    <?php $__currentLoopData = $donvi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-6">
                        <label>
                            <?php echo app('translator')->get('project/QualiAssurance/title.nskt'); ?>
                        </label>

                        <select name="nskt" id="nskt1" class="form-control item-search ns">
                            <?php $__currentLoopData = $nskt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ns->id); ?>">  
                                    <?php echo e($ns->name . " - " . $ns->ten_donvi); ?>
                    ...
                    <div class="col-md-12">
                        <label for="note">
                            <?php echo app('translator')->get('project/QualiAssurance/title.ghichu'); ?>
                        </label>
                        <textarea class="form-control" placeholder="<?php echo app('translator')->get('project/QualiAssurance/title.ghichu'); ?>" name="notes"></textarea>
                    </div>
                </div>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" id="btn-add-kehoach">
                <?php echo app('translator')->get('project/QualiAssurance/title.lkh'); ?>
            </button>
          </div>
      </form>
...
<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="modalDeleteLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalDeleteLabel"><?php echo app('translator')->get('project/QualiAssurance/title.thongbao'); ?></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <h5><?php echo app('translator')->get('project/QualiAssurance/title.bctsmxk'); ?></h5>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo app('translator')->get('project/QualiAssurance/title.huy'); ?></button>
          <button type="button" id="btn-delete" class="btn btn-primary" data-id=""><?php echo app('translator')->get('project/QualiAssurance/title.xoa'); ?></button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalUpdateLabel">
            <?php echo app('translator')->get('project/QualiAssurance/title.cnkh'); ?>
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
            ...
            <div class="container-fuild">
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <label for=""><?php echo app('translator')->get('project/QualiAssurance/title.lvuc'); ?>: </label>
                        <span class="text-primary" id="up_linhvuc"></span>
                    </div>
                    <div class="col-md-6">
                        <label for=""><?php echo app('translator')->get('project/QualiAssurance/title.ngaybd'); ?>: </label>
                        <input class="up_ngaybd form-control flatpickr flatpickr-input" id="up_ngaybd" type="text" placeholder="dd-mm-yyyy" >
                    </div>
                    <div class="col-md-6">
                        <label for=""><?php echo app('translator')->get('project/QualiAssurance/title.nht'); ?>: </label>
                        <input class="up_nht form-control flatpickr flatpickr-input" id="up_nht" type="text" placeholder="dd-mm-yyyy" >
                    </div>
                    <div class="col-md-12">
                        <label for=""><?php echo app('translator')->get('project/QualiAssurance/title.dvpt'); ?>: </label>
                    ...
                    <div class="col-md-12">
                        <label for=""><?php echo app('translator')->get('project/QualiAssurance/title.nskt'); ?>: </label>
                    ...
                    <div class="col-md-12">
                        <label for=""><?php echo app('translator')->get('project/QualiAssurance/title.ghichu'); ?>: </label>
...
<div class="modal fade" id="modalLkh" tabindex="-1" role="dialog" aria-labelledby="modalLkhLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('admin.dambaochatluong.planning.createCcsl')); ?>" method="POST" id="form-lkhNew">
            <?php echo csrf_field(); ?>
          ...
          <div class="modal-body">
            <div class="container-fuild">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="lkh-nbd"><?php echo app('translator')->get('project/QualiAssurance/title.ngaybd'); ?>: </label>
                    ...
                    <div class="col-md-6">
                        <label for="lkh-nht"><?php echo app('translator')->get('project/QualiAssurance/title.nht'); ?>: </label>
...
<div class="modal fade" id="modalCopy" tabindex="-1" role="dialog" aria-labelledby="modalCopyModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('admin.dambaochatluong.planning.copyPlan')); ?>" method="post">
        <?php echo csrf_field(); ?>
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-primary">
                <?php echo app('translator')->get('project/QualiAssurance/title.luukh'); ?>
            </button>
          </div>
        </form>
    </div>
...
<script>
    $("#btn-add-kehoach").click(function() {
        if($("#select-linhvuc").val() == ""){
            alert("Vui lòng chọn lĩnh vực")
        }else if($("#cre_start_time").val() == ""){
            alert("Vui lòng chọn ngày bắt đầu")
        }else if($("#cre_end_time").val() == ""){
            alert("Vui lòng chọn ngày hoàn thành")
        }else if($("#select-donvi").val() == ""){
            alert("Vui lòng chọn đơn vị phụ trách")
        }else if($("#nskt1").val() == ""){
            alert("Vui lòng chọn nhân sự kiểm tra")
        }else{
            $("#form-add-kehoach").submit();
        }
...
<script>
    ...
    $("#turnOnmodalCopy").click(function() {
        ...
        if(namlkh != null && namlkh != "" && namcopykh != null && namcopykh != ""){
            let routeApi = "<?php echo e(route('admin.dambaochatluong.planning.loadDataCopy')); ?>" + "?namlkh="  + namlkh + "&namcopykh=" + namcopykh;
            fetch(routeApi, {
                headers: {
                        ...
                        let dataUI = ` 
                            <div class="row">
                                <div class="col-md-11 mt-3">
                                    <p class="text-primary">
                                        <span class="font-weight-bold">
                                            <?php echo app('translator')->get('project/QualiAssurance/title.lvuc'); ?>: 
                                        </span>
                                        <span>
                                            ${item.mo_ta}
                                        </span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="startDate[]" class="start-date form-control flatpickr flatpickr-input" id="start_time_${item.id}" data-mindate="today" type="text" placeholder="<?php echo app('translator')->get('project/QualiAssurance/title.tgth'); ?>" >
                                </div>
                                <div class="col-md-6">
                                    <label for="end_time">
                                        <?php echo app('translator')->get('project/QualiAssurance/title.nht'); ?>
                                    </label>
                                    <input name="endDate[]" class="end-date form-control flatpickr flatpickr-input" data-mindate="today" id="end_time_${item.id}" type="text" placeholder="<?php echo app('translator')->get('project/QualiAssurance/title.nht'); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="dvpt">
                                        <?php echo app('translator')->get('project/QualiAssurance/title.dvpt'); ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" placeholder="<?php echo app('translator')->get('project/QualiAssurance/title.ghichu'); ?>" name="notes[]">${ item.notes != null ? item.notes : "" }</textarea>
                                </div>
                                <hr>
                            </div>
                         `;
            ...
            alert("Vui lòng chọn năm lập kế hoạch và năm copy kế hoạch")
        }
    })
    ...
    $(document).ready(function(){
        ...
        // });
        // $(".donvi").select2({
        //     placeholder: "<?php echo app('translator')->get('project/QualiAssurance/title.donvi'); ?>",
        //     allowClear: true
        // });
        ...
        var table = $('#table').DataTable({
            ...
            searching: false,
            ajax:  {
                url: "<?php echo route('admin.dambaochatluong.planning.showPlan'); ?>",
                type: 'POST',
                data: {
        ...
        $("#btn-delete").click(function() {
            ...
            let routeApi = "<?php echo e(route('admin.dambaochatluong.planning.deleteCcsl')); ?>" + "?id_delete="  + id_delete;
                fetch(routeApi, {
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
        ...
        $("#update_ccsl").click(function() {
            if($("#up_ngaybd").val() == "" && $("#up_nht").val() == "")
                ...
                let routeApi = "<?php echo e(route('admin.dambaochatluong.planning.updateCcsl')); ?>";
                fetch(routeApi, {
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
...
<script>
    ...
    // });
    $("#nskt1").select2({
        placeholder: "<?php echo app('translator')->get('project/QualiAssurance/title.nskt'); ?>",
        allowClear: true,
        dropdownParent: $('#modalLapKeHoach')
    });
    $("#nskt2").select2({
...
<script>
    $(document).ready(function(){
        var table2 = $('#table2').DataTable({
            ...
            searching: false,
            ajax:  {
                url: "<?php echo route('admin.dambaochatluong.planning.showNotPlan'); ?>",
                type: 'POST'
            },
            columns: [
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/QualiAssurance/planning.blade.php ENDPATH**/ ?>