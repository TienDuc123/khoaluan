...
<section class="content-body">
    <div class="form-standard">
        <div class="form-standard-button mb-4">
            ...
            <a href="<?php echo e(route('admin.thuongtruc.manacategory.exportManafield')); ?>" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('project/Standard/title.xuat_excel'); ?>">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Standard/mana_manafield.blade.php ENDPATH**/ ?>