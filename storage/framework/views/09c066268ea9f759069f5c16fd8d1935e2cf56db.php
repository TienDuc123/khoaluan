<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('project/Selfassessment/title.cnmc'); ?>
...
<div class="block-flex">
    <section class="content-body">
        <div class="block-item">
            <h2><?php echo app('translator')->get('project/Selfassessment/title.cnmc'); ?></h2>
            <div class="form-block">
                        ...
                        <?php $__currentLoopData = $kehoach_baocao; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $khbc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option 
                                <?php if($baocao): ?> 
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                value="<?php echo e($khbc->id); ?>"><?php echo e($khbc->ten_bc); ?>
                            ...
                            <?php $__currentLoopData = $listTC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option  
                                    <?php if($tc->tieuchuan_id == $tieuchuan->id): ?>
                                        selected
                                    <?php endif; ?>
                                 value="<?php echo e($tc->tieuchuan_id); ?>">TC <?php echo e($tc->stt); ?>: <?php echo e($tc->mo_ta); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </select>
                        ...
                        <?php $__currentLoopData = $listTChi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tchi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                                <?php if($tchi->id == $tieuchi->id): ?>
                                    selected
                                <?php endif; ?>
                             value="<?php echo e($tchi->id); ?>">TC <?php echo e($tchi->sttTC); ?>.<?php echo e($tchi->stt); ?>: <?php echo e($tchi->mo_ta); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="block-group">
                        ...
                        <?php $__currentLoopData = $listMCTT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mctt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                                <?php if(in_array($mctt->id, $listminhchungtoithieu)): ?>
                                    selected
                                <?php endif; ?>
                             value="<?php echo e($mctt->id); ?>"><?php echo e($mctt->tieu_de); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="block-group">
                ...
                <div class="block-group">
                    ...
                    <input type="text" placeholder="<?php echo app('translator')->get('project/Selfassessment/title.tmc'); ?>" class="form-control" id="name_minhchung" value="<?php echo e($mcgop->tieu_de); ?>">
                </div>
                <div class="block-group">
                    <label for="trichyeu_mc"><?php echo app('translator')->get('project/Selfassessment/title.trichyeu'); ?></label>
                    <textarea class="form-control" placeholder="<?php echo app('translator')->get('project/Selfassessment/title.tymc'); ?>" id="trichyeu_mc"><?php echo e($mcgop->trich_yeu); ?></textarea>
                </div>
                <div class="block-group">
                    <label><?php echo app('translator')->get('project/Selfassessment/title.congkhai'); ?></label>
                    <input type="checkbox" id="congkhai_checkbox" name="cong_khai"
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamppkhoaluan\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Selfassessment/editproofgroup.blade.php ENDPATH**/ ?>