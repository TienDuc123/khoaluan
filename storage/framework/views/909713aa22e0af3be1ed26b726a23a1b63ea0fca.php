    ...
    <section class="content indexpage pr-3 pl-3">
      ...
      <div class="m-t-md">
      		<div class="h5 text-center">
                <?php echo app('translator')->get('project/Externalreview/title.csdlkdcl'); ?>
            </div>

		    <p class="text-center"><?php echo app('translator')->get('project/Externalreview/title.tdbc'); ?> <?php echo e((($keHoachBaoCaoDetail2->thoi_diem_bao_cao)?\Carbon\Carbon::parse($keHoachBaoCaoDetail2->thoi_diem_bao_cao)->format('d/m/Y'):"Chưa cập nhật")); ?></p>
        ...
        <p><i><strong><?php echo app('translator')->get('project/Externalreview/title.11'); ?></strong></i></p>
        ...
        <form action="<?php echo e(route('admin.tudanhgia.database.save_file_csgd')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="text" hidden value="<?php echo e($idkhbc); ?>" name="id">
    		<p><i><strong><?php echo app('translator')->get('project/Externalreview/title.12'); ?></strong></i></p>
            <p><em><?php echo app('translator')->get('project/Externalreview/title.cpb'); ?></em>
            </p> 
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g12'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g12']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i><strong><?php echo app('translator')->get('project/Externalreview/title.13'); ?></strong></i></p>
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g13'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g13']); ?>' frameborder='0'></iframe>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g14'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g14']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g15'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g15']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g16'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g16']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g17'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g17']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g18_1'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g18_1']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g18_2'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g18_2']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g19_1'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g19_1']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <b>Tổng hợp</b>
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g19_2'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g19_2']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g20'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g20']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g21'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g21']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <div>
                <span>Số lượng người học hệ chính quy đang học tập tại CSGD: </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->g21_slnhcq); ?>" data_key="g21_slnhcq" min="0">
            </div>
            <p><i>
                <strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g22'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g22']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g23'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g23']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g24'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g24']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g25'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g25']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g26'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g26']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g27'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g27']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g28'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g28']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->g28_tysdtnckh); ?>" data_key="g28_tysdtnckh" min="0">
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g29'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g29']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g30'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g30']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p>* Bao gồm đề tài cấp Bộ hoặc tương đương, đề tài nhánh cấp Nhà nước</p>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g31'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g31']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p>* Bao gồm đề tài cấp Bộ hoặc tương đương, đề tài nhánh cấp Nhà nước</p>
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->g31_tyssddxb); ?>" data_key="g31_tyssddxb" min="0">
            </div>
            <p><i><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g32'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g32']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g33'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g33']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->g33_tysbdtc); ?>" data_key="g33_tysbdtc" min="0">
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g34'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g34']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g35'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g35']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->g35_tysbbc); ?>" data_key="g35_tysbbc" min="0">
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g36'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g36']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g37'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g37']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g38_1'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g38_1']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p>*Bao gồm đề tài cấp Bộ hoặc tương đương, đề tài nhánh cấp nhà nước</p>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g38_2'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g38_2']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g39'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g39']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i><strong>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g40'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g40']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['g41'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['g41']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><i>
            ...
            <?php $fiveYearAgo = $keHoachBaoCaoDetail2->nam - 5; $key1 = 1; $key2 = 1;$key3 = 1;$key4 = 1;$key5 = 1;$key6 = 1;$key7 = 1;?>
            <?php for($i=$fiveYearAgo+1;$i<$fiveYearAgo+6;$i++): ?>
                <div>
                    <span>- Năm <?php echo e($i); ?>: </span>
                    <input type="number" class="edit_input" value="<?php echo e($dulieu->{'g42_'.$key1}); ?>" data_key="g42_<?php echo e($key1); ?>" min="0">
                </div>
                <?php $key1++; ?>
            <?php endfor; ?>
            ...
            <?php for($i=$fiveYearAgo+1;$i<$fiveYearAgo+6;$i++): ?>
                <div>
                    <span>- Năm <?php echo e($i); ?>: </span>
                    <input type="number" class="edit_input" value="<?php echo e($dulieu->{'g43_'.$key2}); ?>" data_key="g43_<?php echo e($key2); ?>" min="0">
                </div>
                <?php $key2++; ?>
            <?php endfor; ?>
            <p><i>
            ...
            <?php for($i=$fiveYearAgo+1;$i<$fiveYearAgo+6;$i++): ?>
                <div>
                    <span>- Năm <?php echo e($i); ?>: </span>
                    <input type="number" class="edit_input" value="<?php echo e($dulieu->{'g44_'.$key3}); ?>" data_key="g44_<?php echo e($key3); ?>" min="0">
                </div>
                <?php $key3++; ?>
            <?php endfor; ?>
            <p><i>
            ...
            <?php for($i=$fiveYearAgo+1;$i<$fiveYearAgo+6;$i++): ?>
                <div>
                    <span>- Năm <?php echo e($i); ?>: </span>
                    <input type="number" class="edit_input" value="<?php echo e($dulieu->{'g45_'.$key4}); ?>" data_key="g45_<?php echo e($key4); ?>" min="0">
                </div>
                <?php $key4++; ?>
            <?php endfor; ?>
            <p><i>
            ...
            <?php for($i=$fiveYearAgo+1;$i<$fiveYearAgo+6;$i++): ?>
                <div>
                    <span>- Năm <?php echo e($i); ?>: </span>
                    <input type="number" class="edit_input" value="<?php echo e($dulieu->{'g46_'.$key5}); ?>" data_key="g46_<?php echo e($key5); ?>" min="0">
                </div>
                <?php $key5++; ?>
            <?php endfor; ?>
            <p><i>
            ...
            <?php for($i=$fiveYearAgo+1;$i<$fiveYearAgo+6;$i++): ?>
                <div>
                    <span>- Năm <?php echo e($i); ?>: </span>
                    <input type="number" class="edit_input" value="<?php echo e($dulieu->{'g47_'.$key6}); ?>" data_key="g47_<?php echo e($key6); ?>" min="0">
                </div>
                <?php $key6++; ?>
            <?php endfor; ?>
            <p><i>
            ...
            <?php for($i=$fiveYearAgo+1;$i<$fiveYearAgo+6;$i++): ?>
                <div>
                    <span>- Năm <?php echo e($i); ?>: </span>
                    <input type="number" class="edit_input" value="<?php echo e($dulieu->{'g48_'.$key7}); ?>" data_key="g48_<?php echo e($key7); ?>" min="0">
                </div>
                <?php $key7++; ?>
            <?php endfor; ?>
            ...
            <div class="parent_ex">
                ...
                <span class="file_name text-warning fst-italic"></span>
                <div class="import_ex">
                    <?php if(isset($data['gvi'])): ?>
                        <iframe src='<?php echo e(URL::to('/') . '/' . $data['gvi']); ?>' frameborder='0'></iframe>
                    <?php endif; ?>
                </div> 
            </div>
            <p><strong>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_1_tsgvch); ?>" data_key="vii_1_tsgvch" min="0">
            </div>
            <div>
                <span>Tỷ lệ giảng viên cơ hữu trên tổng số cán bộ cơ hữu (%): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_1_tlgvch); ?>" data_key="vii_1_tlgvch" min="0">
            </div>
            <div>
                <span>Tỷ lệ giảng viên cơ hữu có trình độ tiến sĩ trở lên trên tổng số giảng viên cơ hữu của đơn vị thực hiện CSGD (%): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_1_tlgvchts); ?>" data_key="vii_1_tlgvchts" min="0">
            </div>
            <div>
                <span>Tỷ lệ giảng viên cơ hữu có trình độ tiến sĩ trở lên trên tổng số giảng viên cơ hữu của đơn vị thực hiện CSGD (%): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_1_tlgvchths); ?>" data_key="vii_1_tlgvchths" min="0">
            </div>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_2_tssvcq); ?>" data_key="vii_2_tssvcq" min="0">
            </div>
            <div>
                <span>Tỷ số sinh viên trên giảng viên (sau khi quy đổi): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_2_tssvtgv); ?>" data_key="vii_2_tssvtgv" min="0">
            </div>
            <div>
                <span>Tỷ lệ sinh viên tốt nghiệp so với số tuyển vào (%): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_2_tlsvtn); ?>" data_key="vii_2_tlsvtn" min="0">
            </div>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_3_tlsvtl); ?>" data_key="vii_3_tlsvtl" min="0">
            </div>
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_3_tlsvknct); ?>" data_key="vii_3_tlsvknct" min="0">
            </div>
            <p><i><strong>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_4_tlsvdn); ?>" data_key="vii_4_tlsvdn" min="0">
            </div>
            <div>
                <span>Tỷ lệ sinh viên có việc làm trái ngành đào tạo (%): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_4_tlsvtn); ?>" data_key="vii_4_tlsvtn" min="0">
            </div>
            <div>
                <span>Tỷ lệ tự tạo được việc làm trong số sinh viên có việc làm (%): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_4_tlttdvl); ?>" data_key="vii_4_tlttdvl" min="0">
            </div>
            <div>
                <span>Thu nhập bình quân/tháng của sinh viên có việc làm (triệu VNĐ): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_4_tnbq); ?>" data_key="vii_4_tnbq" min="0">
            </div>
            <p><i><strong>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_5_tlsvduyc); ?>" data_key="vii_5_tlsvduyc" min="0">
            </div>
            <div>
                <span>Tỷ lệ sinh viên cơ bản đáp ứng yêu cầu của công việc, nhưng phải đào tạo thêm (%): </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_5_tlsvcb); ?>" data_key="vii_5_tlsvcb" min="0">
            </div>
            <p><i><strong>
            ...
            <div>
                <span>Tỷ số đề tài nghiên cứu khoa học và chuyển giao khoa học công nghệ trên cán bộ cơ hữu: </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_6_tlsdtnckh); ?>" data_key="vii_6_tlsdtnckh" min="0">
            </div>
            <div>
                <span>Tỷ số doanh thu từ NCKH và chuyển giao công nghệ trên cán bộ cơ hữu: </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_6_dtnckh); ?>" data_key="vii_6_dtnckh" min="0">
            </div>
            <div>
                <span>Tỷ số sách đã được xuất bản trên cán bộ cơ hữu: </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_6_tssxb); ?>" data_key="vii_6_tssxb" min="0">
            </div>
            <div>
                <span>Tỷ số bài đăng tạp chí trên cán bộ cơ hữu: </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_6_tsbdtc); ?>" data_key="vii_6_tsbdtc" min="0">
            </div>
            <div>
                <span>Tỷ số bài báo cáo trên cán bộ cơ hữu: </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_6_tsbbc); ?>" data_key="vii_6_tsbbc" min="0">
            </div>
            ...
            <div>
                ...
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_7_tsdts); ?>" data_key="vii_7_tsdts" min="0">
            </div>
            <div>
                <span>Tỷ số chỗ ở ký túc xá trên sinh viên chính quy: </span>
                <input type="number" class="edit_input" value="<?php echo e($dulieu->vii_7_tscokt); ?>" data_key="vii_7_tscokt" min="0">
            </div>
            <p><i><strong>
...
<script type="text/javascript" src="<?php echo e(asset('js/baocaoctdt.js')); ?>"></script>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\Khoaluantotnghiep\kdcl-2023\resources\views/admin/project/Database/data_school_csgd.blade.php ENDPATH**/ ?>